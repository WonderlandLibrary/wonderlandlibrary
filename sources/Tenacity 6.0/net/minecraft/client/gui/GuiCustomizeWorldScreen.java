...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    private void func_175325_f() {
        ...
        this.field_175349_r = new GuiPageButtonList(this.mc2, this.width, this.height, 32, this.height - 32, 25, this, new GuiPageButtonList.GuiListEntry[][] { aguipagebuttonlist$guilistentry, aguipagebuttonlist$guilistentry2, aguipagebuttonlist$guilistentry3, aguipagebuttonlist$guilistentry4 });
        for (int i = 0; i < 4; ++i) {
        ...
        if (button.enabled) {
            switch (button.id) {
                case 300: {
                    ...
                    this.mc2.displayGuiScreen(this.field_175343_i);
                    break;
                }
                case 301: {
                ...
                case 305: {
                    this.mc2.displayGuiScreen(new GuiScreenCustomizePresets(this));
                    break;
                }
                case 306: {
                    this.func_175331_h();
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            ...
            this.mc2.getTextureManager().bindTexture(GuiCustomizeWorldScreen.optionsBackground);
            ...
            this.field_175352_x.drawButton(this.mc2, mouseX, mouseY);
            this.field_175351_y.drawButton(this.mc2, mouseX, mouseY);
        }
    }
}
