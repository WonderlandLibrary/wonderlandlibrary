...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient
{
    ...
    private void func_175266_a(final int p_175266_1_, final int p_175266_2_, final float p_175266_3_, final float p_175266_4_, final ISpectatorMenuObject p_175266_5_) {
        ...
        if (p_175266_5_ != SpectatorMenu.field_178657_a) {
            ...
            if (i > 3 && p_175266_5_.func_178662_A_()) {
                this.field_175268_g.fontRendererObj.drawStringWithShadow(s, p_175266_2_ + 19 - 2 - this.field_175268_g.fontRendererObj.getStringWidth(s), p_175266_3_ + 6.0f + 3.0f, 16777215 + (i << 24));
            }
        }
    }
    ...
    public void renderSelectedItem(final ScaledResolution p_175263_1_) {
        ...
        if (i > 3 && this.field_175271_i != null) {
            ...
            if (s != null) {
                final int j = (int)((p_175263_1_.getScaledWidth() - this.field_175268_g.fontRendererObj.getStringWidth(s)) / 2.0f);
