                                ...
                                if (d9 * d9 + d10 * d10 < 1.0) {
                                    for (int j4 = m; j4 > l2; --j4) {
                                        ...
                                        if (d11 > -0.7 && d9 * d9 + d11 * d11 + d10 * d10 < 1.0) {
                                            ...
                                            final IBlockState iblockstate3 = (IBlockState)MoreObjects.firstNonNull((Object)p_180702_5_.getBlockState(j3, j4 + 1, i4), (Object)Blocks.air.getDefaultState());
                                            ...
                                            if (this.func_175793_a(iblockstate2, iblockstate3)) {
                                                if (j4 - 1 < 10) {
                                                    ...
                                                    if (flag5 && p_180702_5_.getBlockState(j3, j4 - 1, i4).getBlock() == Blocks.dirt) {
                                                        blockpos$mutableblockpos.set(j3 + p_180702_3_ * 16, 0, i4 + p_180702_4_ * 16);
