...
public final class Rfc5424Layout extends AbstractStringLayout
{
    ...
    static {
        ...
        ENTERPRISE_ID_PATTERN = Pattern.compile("\\d+(\\.\\d+)*");
    }
    ...
    public static class Rfc5424LayoutBuilder
    {
        ...
        public Rfc5424LayoutBuilder setIncludes(final String includes) {
        ...
        public Rfc5424Layout build() {
            ...
            return new Rfc5424Layout(this.config, this.facility, this.id, this.ein, this.includeMDC, this.includeNL, this.escapeNL, this.mdcId, this.mdcPrefix, this.eventPrefix, this.appName, this.messageId, this.excludes, this.includes, this.required, this.charset, this.exceptionPattern, this.useTLSMessageFormat, this.loggerFields, null);
        }
    }
