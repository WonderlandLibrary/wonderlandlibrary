...
public class FilenameUtils {
    ...
    private static String doNormalize(String filename, char separator, boolean keepSeparator) {
        ...
        block3: for (i2 = prefix + 2; i2 < size; ++i2) {
            ...
            for (int j2 = i2 - 4; j2 >= prefix; --j2) {
                if (array[j2] != separator) continue;
                System.arraycopy(array, i2 + 1, array, j2 + 1, size - i2);
                size -= i2 - j2;
                i2 = j2 + 1;
                continue block3;
            }
