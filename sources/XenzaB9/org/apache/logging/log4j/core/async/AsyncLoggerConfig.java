...
public class AsyncLoggerConfig extends LoggerConfig
{
    ...
    public static class Builder<B extends Builder<B>> extends LoggerConfig.Builder<B>
    {
        ...
        public LoggerConfig build() {
            final String name = this.getLoggerName().equals("root") ? "" : this.getLoggerName();
            final LevelAndRefs container = LoggerConfig.getLevelAndRefs(this.getLevel(), this.getRefs(), this.getLevelAndRefs(), this.getConfig());
    ...
    public static class RootLogger extends LoggerConfig
    {
        ...
        public static class Builder<B extends Builder<B>> extends LoggerConfig.RootLogger.Builder<B>
        {
            ...
            public LoggerConfig build() {
                final LevelAndRefs container = LoggerConfig.getLevelAndRefs(this.getLevel(), this.getRefs(), this.getLevelAndRefs(), this.getConfig());
                return new AsyncLoggerConfig("", container.refs, this.getFilter(), container.level, this.isAdditivity(), this.getProperties(), this.getConfig(), LoggerConfig.includeLocation(this.getIncludeLocation()));
            }
        }
    }
}
