...
implements DatagramChannel {
    ...
    protected Object filterOutboundMessage(Object msg) {
        ...
        if (msg instanceof AddressedEnvelope && (e2 = (AddressedEnvelope)msg).content() instanceof ByteBuf && (e2.recipient() == null || e2.recipient() instanceof InetSocketAddress)) {
            ByteBuf content = (ByteBuf)e2.content();
            if (content.hasMemoryAddress()) {
                return e2;
            }
            return new DefaultAddressedEnvelope<ByteBuf, InetSocketAddress>(this.newDirectBuffer(e2, content), (InetSocketAddress)e2.recipient());
        }
