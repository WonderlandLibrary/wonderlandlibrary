...
public class GuiShareToLan extends GuiScreen
{
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.id == 102) {
            this.mc2.displayGuiScreen(this.field_146598_a);
        }
            ...
            final String s = this.mc2.getIntegratedServer().shareToLAN(WorldSettings.GameType.getByName(this.field_146599_h), this.field_146600_i);
            ...
            this.mc2.ingameGUI.getChatGUI().printChatMessage(ichatcomponent);
        }
    }
