...
extends NVProgram {
    ...
    public static void glProgramNamedParameter4fNV(int id, ByteBuffer name, float x2, float y2, float z2, float w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramNamedParameter4fNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(name);
        NVFragmentProgram.nglProgramNamedParameter4fNV(id, name.remaining(), MemoryUtil.getAddress(name), x2, y2, z2, w2, function_pointer);
    }
    ...
    public static void glProgramNamedParameter4dNV(int id, ByteBuffer name, double x2, double y2, double z2, double w2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramNamedParameter4dNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(name);
        NVFragmentProgram.nglProgramNamedParameter4dNV(id, name.remaining(), MemoryUtil.getAddress(name), x2, y2, z2, w2, function_pointer);
    }
