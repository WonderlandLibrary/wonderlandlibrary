...
implements Comparable<Fraction> {
    ...
    public Fraction pow(int power) {
        ...
        Fraction f2 = this.multiplyBy(this);
        if (power % 2 == 0) {
            return f2.pow(power / 2);
        }
        return f2.pow(power / 2).multiplyBy(this);
    }
    ...
    private Fraction addSub(Fraction fraction, boolean isAdd) {
        ...
        return new Fraction(w2.intValue(), Fraction.mulPosAndCheck(this.denominator / d1, fraction.denominator / d2));
    }
