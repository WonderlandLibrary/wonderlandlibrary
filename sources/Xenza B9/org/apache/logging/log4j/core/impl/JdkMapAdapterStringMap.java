...
public class JdkMapAdapterStringMap implements StringMap
{
    ...
    private String[] getSortedKeys() {
        if (this.sortedKeys == null) {
            Arrays.sort(this.sortedKeys = this.map.keySet().toArray(Strings.EMPTY_ARRAY), JdkMapAdapterStringMap.NULL_FIRST_COMPARATOR);
        }
    ...
    static {
        ...
        JdkMapAdapterStringMap.PUT_ALL = ((key, value, stringStringMap) -> {
            final String s2 = stringStringMap.put(key, value);
        });
    }
}
