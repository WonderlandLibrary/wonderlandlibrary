...
extends Source {
    ...
    public SourceLWJGLOpenAL(FloatBuffer listenerPosition, IntBuffer myBuffer, boolean priority, boolean toStream, boolean toLoop, String sourcename, FilenameURL filenameURL, SoundBuffer soundBuffer, float x2, float y2, float z2, int attModel, float distOrRoll, boolean temporary) {
        super(priority, toStream, toLoop, sourcename, filenameURL, soundBuffer, x2, y2, z2, attModel, distOrRoll, temporary);
    ...
    public SourceLWJGLOpenAL(FloatBuffer listenerPosition, AudioFormat audioFormat, boolean priority, String sourcename, float x2, float y2, float z2, int attModel, float distOrRoll) {
        super(audioFormat, priority, sourcename, x2, y2, z2, attModel, distOrRoll);
        this.channelOpenAL = (ChannelLWJGLOpenAL)this.channel;
        this.listenerPosition = listenerPosition;
        this.libraryType = LibraryLWJGLOpenAL.class;
        this.pitch = 1.0f;
    ...
    public void changeSource(FloatBuffer listenerPosition, IntBuffer myBuffer, boolean priority, boolean toStream, boolean toLoop, String sourcename, FilenameURL filenameURL, SoundBuffer soundBuffer, float x2, float y2, float z2, int attModel, float distOrRoll, boolean temporary) {
        super.changeSource(priority, toStream, toLoop, sourcename, filenameURL, soundBuffer, x2, y2, z2, attModel, distOrRoll, temporary);
        this.listenerPosition = listenerPosition;
        this.myBuffer = myBuffer;
        this.pitch = 1.0f;
        this.resetALInformation();
    ...
    public void setPosition(float x2, float y2, float z2) {
        super.setPosition(x2, y2, z2);
        if (this.sourcePosition == null) {
            this.resetALInformation();
        } else {
            this.positionChanged();
        }
        this.sourcePosition.put(0, x2);
        this.sourcePosition.put(1, y2);
        this.sourcePosition.put(2, z2);
    ...
    public void setVelocity(float x2, float y2, float z2) {
        super.setVelocity(x2, y2, z2);
        this.sourceVelocity = BufferUtils.createFloatBuffer(3).put(new float[]{x2, y2, z2});
    ...
    public void play(Channel c2) {
        ...
        boolean bl = newChannel = this.channel != c2;
