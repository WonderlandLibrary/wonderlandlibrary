...
public class Constructor extends SafeConstructor
{
    ...
    public Constructor(final LoaderOptions loadingConfig) {
    ...
    public Constructor(final Class<?> theRoot, final LoaderOptions loadingConfig) {
    ...
    public Constructor(final TypeDescription theRoot, final LoaderOptions loadingConfig) {
    ...
    public Constructor(final TypeDescription theRoot, final Collection<TypeDescription> moreTDs, final LoaderOptions loadingConfig) {
        super(loadingConfig);
        if (theRoot == null) {
    ...
    public Constructor(final String theRoot, final LoaderOptions loadingConfig) throws ClassNotFoundException {
                    ...
                    if (!typeDetected && valueNode.getNodeId() != NodeId.scalar) {
                        ...
                        if (arguments != null && arguments.length > 0) {
                            if (valueNode.getNodeId() == NodeId.sequence) {
                                ...
                                mnode2.setTypes(keyType, valueType);
            ...
            if (type == String.class) {
                ...
                try {
                    if (Constructor.this.loadingConfig.isEnumCaseSensitive()) {
                        ...
                        result = EnumUtils.findEnumInsensitiveCase((Class<Object>)type, enumValueName);
                    }
                }
