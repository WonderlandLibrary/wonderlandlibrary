...
extends AnnotatedMixinElementHandler {
    ...
    extends AnnotatedMixinElementHandler.AnnotatedElement<ExecutableElement> {
        ...
        public AnnotatedElementInjector(ExecutableElement element, AnnotationHandle annotation2, InjectorRemap shouldRemap) {
            super(element, annotation2);
        ...
        public void addMessage(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationHandle annotation2) {
            this.state.addMessage(kind, msg, element, annotation2);
        }
