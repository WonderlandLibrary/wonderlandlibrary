...
public abstract class ServerConfigurationManager
{
    ...
    public void initializeConnectionToPlayer(final NetworkManager netManager, final EntityPlayerMP playerIn) {
        ...
        ServerConfigurationManager.logger.info(playerIn.getName() + "[" + s2 + "] logged in with entity id " + playerIn.getEntityId() + " at (" + playerIn.posX + ", " + playerIn.posY + ", " + playerIn.posZ + ")");
    ...
    public void transferEntityToWorld(final Entity entityIn, final int p_82448_2_, final WorldServer oldWorldIn, final WorldServer toWorldIn) {
        ...
        if (entityIn.dimension == -1) {
            d0 = MathHelper.clamp_double(d0 / d3, toWorldIn.getWorldBorder().minX() + 16.0, toWorldIn.getWorldBorder().maxX() - 16.0);
            d2 = MathHelper.clamp_double(d2 / d3, toWorldIn.getWorldBorder().minZ() + 16.0, toWorldIn.getWorldBorder().maxZ() - 16.0);
    ...
    public boolean bypassesPlayerLimit(final GameProfile p_183023_1_) {
        return false;
    }
