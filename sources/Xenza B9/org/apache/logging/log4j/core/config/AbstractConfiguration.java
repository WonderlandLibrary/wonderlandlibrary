...
public abstract class AbstractConfiguration extends AbstractFilterable implements Configuration
{
    ...
    public void initialize() {
        ...
        final String scriptLanguages = PropertiesUtil.getProperties().getStringProperty("log4j2.Script.enableLanguages");
    ...
    public boolean stop(final long timeout, final TimeUnit timeUnit) {
        ...
        final Appender[] array = this.appenders.values().toArray(Appender.EMPTY_ARRAY);
        ...
        if (this.advertiserNode != null) {
            ...
            if (type != null) {
                ...
                try {
                    ...
                    AbstractConfiguration.LOGGER.error("{} attempting to instantiate advertiser: {}", e.getClass().getSimpleName(), nodeName, e);
                }
            }
        }
    }
    ...
    protected void doConfigure() {
        ...
        if (this.rootNode.hasChildren() && this.rootNode.getChildren().get(0).getName().equalsIgnoreCase("Properties")) {
            ...
            final Interpolator interpolator = new Interpolator(lookup, this.pluginPackages);
    ...
    public static Level getDefaultLevel() {
        final String levelName = PropertiesUtil.getProperties().getStringProperty("org.apache.logging.log4j.level", Level.ERROR.name());
