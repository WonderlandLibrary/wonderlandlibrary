...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable
{
    ...
    private final class KeySet extends Maps.KeySet<K, V>
    {
        ...
        public boolean remove(@Nullable final Object o) {
            final BiEntry<K, V> entry = HashBiMap.this.seekByKey(o, hash(o));
            if (entry == null) {
                return false;
            }
    ...
    private final class Inverse extends AbstractMap<V, K> implements BiMap<V, K>, Serializable
    {
        ...
        public K get(@Nullable final Object value) {
            final BiEntry<K, V> entry = HashBiMap.this.seekByValue(value, hash(value));
        ...
        private final class InverseKeySet extends Maps.KeySet<V, K>
        {
            ...
            @Override
            public boolean remove(@Nullable final Object o) {
                final BiEntry<K, V> entry = HashBiMap.this.seekByValue(o, hash(o));
                if (entry == null) {
                    return false;
                }
                HashBiMap.this.delete(entry);
