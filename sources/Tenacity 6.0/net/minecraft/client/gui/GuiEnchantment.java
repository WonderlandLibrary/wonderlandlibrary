...
public class GuiEnchantment extends GuiContainer
{
    ...
    protected void mouseClicked(final int mouseX, final int mouseY, final int mouseButton) throws IOException {
        ...
        for (int k = 0; k < 3; ++k) {
            ...
            if (l >= 0 && i2 >= 0 && l < 108 && i2 < 19 && this.container.enchantItem(this.mc2.thePlayer, k)) {
                this.mc2.playerController.sendEnchantPacket(this.container.windowId, k);
            }
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        this.mc2.getTextureManager().bindTexture(GuiEnchantment.ENCHANTMENT_TABLE_GUI_TEXTURE);
        final int i = (this.width - this.xSize) / 2;
        final int j = (this.height - this.ySize) / 2;
        ...
        final ScaledResolution scaledresolution = new ScaledResolution(this.mc2);
        ...
        this.mc2.getTextureManager().bindTexture(GuiEnchantment.ENCHANTMENT_TABLE_BOOK_TEXTURE);
        ...
        GlStateManager.matrixMode(5889);
        GlStateManager.viewport(0, 0, this.mc2.displayWidth, this.mc2.displayHeight);
        ...
        for (int l = 0; l < 3; ++l) {
            ...
            if (l2 == 0) {
                ...
                final String s2 = "" + l2;
                IFontRenderer fontrenderer = this.mc2.standardGalacticFontRenderer;
                int i3 = 6839882;
                if ((k < l + 1 || this.mc2.thePlayer.experienceLevel < l2) && !this.mc2.thePlayer.capabilities.isCreativeMode) {
                    this.drawTexturedModalRect(i2, j + 14 + 19 * l, 0, 185, 108, 19);
                ...
                fontrenderer = this.mc2.fontRendererObj;
                fontrenderer.drawStringWithShadow(s2, j2 + 86 - fontrenderer.getStringWidth(s2), (float)(j + 16 + 19 * l + 7), i3);
            }
        }
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final boolean flag = this.mc2.thePlayer.capabilities.isCreativeMode;
        final int i = this.container.getLapisAmount();
        for (int j = 0; j < 3; ++j) {
            final int k = this.container.enchantLevels[j];
            final int l = this.container.enchantmentIds[j];
            final int i2 = j + 1;
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0) {
                ...
                if (!flag) {
                    ...
                    if (this.mc2.thePlayer.experienceLevel < k) {
