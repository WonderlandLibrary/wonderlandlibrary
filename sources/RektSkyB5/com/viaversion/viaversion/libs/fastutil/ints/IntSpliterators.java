...
public final class IntSpliterators {
    ...
    public static IntSpliterator asIntSpliterator(Spliterator i2) {
        if (i2 instanceof IntSpliterator) {
            return (IntSpliterator)i2;
        }
        if (i2 instanceof Spliterator.OfInt) {
            return new PrimitiveSpliteratorWrapper((Spliterator.OfInt)i2);
        }
        return new SpliteratorWrapper(i2);
    }

    public static IntSpliterator asIntSpliterator(Spliterator i2, IntComparator comparatorOverride) {
        if (i2 instanceof IntSpliterator) {
        ...
        if (i2 instanceof Spliterator.OfInt) {
            return new PrimitiveSpliteratorWrapperWithComparator((Spliterator.OfInt)i2, comparatorOverride);
        }
        return new SpliteratorWrapperWithComparator(i2, comparatorOverride);
    }
    ...
    public static IntSpliterator concat(IntSpliterator ... a2) {
        return IntSpliterators.concat(a2, 0, a2.length);
    }

    public static IntSpliterator concat(IntSpliterator[] a2, int offset, int length) {
        return new SpliteratorConcatenator(a2, offset, length);
    }
    ...
    implements IntSpliterator {
        ...
        public long skip(long n2) {
            ...
            if (n2 < (long)remaining) {
                this.curr = SafeMath.safeLongToInt((long)this.curr + n2);
                return n2;
            }
            n2 = remaining;
    ...
    implements IntSpliterator {
        ...
        public PrimitiveSpliteratorWrapper(Spliterator.OfInt i2) {
            this.i = i2;
        }
    ...
    implements IntSpliterator {
        ...
        public SpliteratorWrapper(Spliterator<Integer> i2) {
            this.i = i2;
        }
    ...
    extends PrimitiveSpliteratorWrapper {
        ...
        public PrimitiveSpliteratorWrapperWithComparator(Spliterator.OfInt i2, IntComparator comparator) {
            super(i2);
            this.comparator = comparator;
        }
    ...
    extends SpliteratorWrapper {
        ...
        public SpliteratorWrapperWithComparator(Spliterator<Integer> i2, IntComparator comparator) {
            super(i2);
            this.comparator = comparator;
        }
    ...
    implements IntSpliterator {
        ...
        public long skip(long n2) {
            ...
            long newCurr = (long)this.curr + n2;
    ...
    implements IntSpliterator {
        ...
        public SpliteratorConcatenator(IntSpliterator[] a2, int offset, int length) {
            this.a = a2;
            this.offset = offset;
            this.length = length;
        ...
        public long skip(long n2) {
            ...
            while (skipped < n2 && this.length >= 0) {
                long curSkipped;
                if ((skipped += (curSkipped = this.a[this.offset].skip(n2 - skipped))) >= n2) continue;
                this.advanceNextSpliterator();
            }
            return skipped;
        }
    ...
    implements IntSpliterator {
        ...
        public long skip(long n2) {
            ...
            if (this.iter instanceof IntBigListIterator) {
                long skipped2 = ((IntBigListIterator)this.iter).skip(n2);
                this.size -= skipped2;
                return skipped2;
            }
            for (skippedSoFar = 0L; skippedSoFar < n2 && this.iter.hasNext(); skippedSoFar += (long)skipped) {
                skipped = this.iter.skip(SafeMath.safeLongToInt(Math.min(n2, Integer.MAX_VALUE)));
    ...
    IntConsumer {
        ...
        public int skip(int n2) {
            ...
            if (n2 > 0) {
                skipped += SafeMath.safeLongToInt(this.spliterator.skip(n2));
            }
            return skipped;
        }
    }
