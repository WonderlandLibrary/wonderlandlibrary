    ...
    protected void processLogLevelColors(Document doc) {
        ...
        for (int i = 0; i < nodeList.getLength(); ++i) {
            ...
            try {
                ...
                int red2 = Integer.parseInt(this.getValue(map, RED));
                int green2 = Integer.parseInt(this.getValue(map, GREEN));
                int blue2 = Integer.parseInt(this.getValue(map, BLUE));
                Color c = new Color(red2, green2, blue2);
