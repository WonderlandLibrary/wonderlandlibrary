...
implements SpdyDataFrame {
    ...
    public SpdyDataFrame copy() {
        DefaultSpdyDataFrame frame = new DefaultSpdyDataFrame(this.getStreamId(), this.content().copy());
    ...
    public SpdyDataFrame duplicate() {
        DefaultSpdyDataFrame frame = new DefaultSpdyDataFrame(this.getStreamId(), this.content().duplicate());
        frame.setLast(this.isLast());
        return frame;
    }
