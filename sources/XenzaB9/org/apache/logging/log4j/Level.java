...
public final class Level implements Comparable<Level>, Serializable
{
    ...
    private Level(final String name, final int intLevel) {
        ...
        if (Level.LEVELS.putIfAbsent(toUpperCase(name.trim()), this) != null) {
    ...
    public static Level forName(final String name, final int intValue) {
        ...
        final Level level = Level.LEVELS.get(normalizedName);
        if (level != null) {
            return level;
        }
        try {
    ...
    public static Level getLevel(final String name) {
        ...
        return Level.LEVELS.get(toUpperCase(name.trim()));
    }
    ...
    public static Level[] values() {
        return Level.LEVELS.values().toArray(Level.EMPTY_ARRAY);
    }
