...
public class LogManager
{
    ...
    public static LoggerContext getContext() {
        try {
            ...
            return SimpleLoggerContextFactory.INSTANCE.getContext(LogManager.FQCN, null, null, true);
        }
    }
    ...
    public static LoggerContext getContext(final boolean currentContext) {
        try {
            ...
            LogManager.LOGGER.warn(ex.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(LogManager.FQCN, null, null, currentContext, null, null);
        }
    }
    ...
    public static LoggerContext getContext(final ClassLoader loader, final boolean currentContext) {
        try {
            ...
            LogManager.LOGGER.warn(ex.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(LogManager.FQCN, loader, null, currentContext);
        }
    }
    ...
    public static LoggerContext getContext(final ClassLoader loader, final boolean currentContext, final Object externalContext) {
        try {
            ...
            LogManager.LOGGER.warn(ex.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(LogManager.FQCN, loader, externalContext, currentContext);
        }
    }
    ...
    public static LoggerContext getContext(final ClassLoader loader, final boolean currentContext, final URI configLocation) {
        try {
            ...
            LogManager.LOGGER.warn(ex.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(LogManager.FQCN, loader, null, currentContext, configLocation, null);
        }
    }
    ...
    public static LoggerContext getContext(final ClassLoader loader, final boolean currentContext, final Object externalContext, final URI configLocation) {
        try {
            ...
            LogManager.LOGGER.warn(ex.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(LogManager.FQCN, loader, externalContext, currentContext, configLocation, null);
        }
    }
    ...
    public static LoggerContext getContext(final ClassLoader loader, final boolean currentContext, final Object externalContext, final URI configLocation, final String name) {
        try {
            ...
            LogManager.LOGGER.warn(ex.getMessage() + " Using SimpleLogger");
            return SimpleLoggerContextFactory.INSTANCE.getContext(LogManager.FQCN, loader, externalContext, currentContext, configLocation, name);
        }
    }
