...
public class ModelBiped extends ModelBase
{
    ...
    @Override
    public void setRotationAngles(float limbSwing, float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scaleFactor, final Entity entityIn) {
        limbSwing = (TargetHUDMod.renderLayers ? limbSwing : 0.0f);
        limbSwingAmount = (TargetHUDMod.renderLayers ? limbSwingAmount : 0.0f);
        ...
        if (this.swingProgress > -9990.0f) {
            float f;
            final float swingProgressCustom = f = (TargetHUDMod.renderLayers ? this.swingProgress : 0.0f);
            ...
            f = 1.0f - swingProgressCustom;
            f *= f;
            f *= f;
            f = 1.0f - f;
            final float f2 = MathHelper.sin(f * 3.1415927f);
            final float f3 = MathHelper.sin(swingProgressCustom * 3.1415927f) * -(this.bipedHead.rotateAngleX - 0.7f) * 0.75f;
            ...
            bipedRightArm4.rotateAngleZ += MathHelper.sin(swingProgressCustom * 3.1415927f) * -0.4f;
        }
        if (this.isSneak) {
