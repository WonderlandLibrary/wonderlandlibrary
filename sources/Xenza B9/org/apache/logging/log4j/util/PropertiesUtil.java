...
public final class PropertiesUtil
{
    ...
    static {
        LOG4J_PROPERTIES = new PropertiesUtil("log4j2.component.properties", false);
    }
    ...
    private static class Environment
    {
        ...
        private Environment(final PropertySource propertySource) {
            ...
            this.literal = new ConcurrentHashMap<String, String>();
            this.normalized = new ConcurrentHashMap<String, String>();
            this.tokenized = new ConcurrentHashMap<List<CharSequence>, String>();
            final PropertyFilePropertySource sysProps = new PropertyFilePropertySource("log4j2.system.properties", false);
            try {
        ...
        private synchronized void reload() {
            ...
            this.sources.stream().map((Function<? super Object, ? extends Set<String>>)PropertySource::getPropertyNames).reduce(keys, (left, right) -> {
                left.addAll(right);
                return left;
            });
            keys.stream().filter(Objects::nonNull).forEach(key -> {
                ...
                this.sources.forEach(source -> {
                    ...
                    if (normalKey != null) {
                        ...
                        if (normalValue != null) {
                            this.normalized.putIfAbsent(key, normalValue);
                        }
                    }
                });
            });
