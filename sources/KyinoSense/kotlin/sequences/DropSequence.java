...
DropTakeSequence<T> {
    ...
    public Sequence<T> drop(int n) {
        ...
        int n1 = n2;
        boolean bl3 = false;
        return n1 < 0 ? (Sequence)new DropSequence<T>(this, n) : (Sequence)new DropSequence<T>(this.sequence, n1);
    }
    ...
    public Sequence<T> take(int n) {
        ...
        int n1 = n2;
        boolean bl3 = false;
        return n1 < 0 ? (Sequence)new TakeSequence(this, n) : (Sequence)new SubSequence<T>(this.sequence, this.count, n1);
    }
    ...
    public Iterator<T> iterator() {
        return new Iterator<T>(this){
            ...
            {
                this.this$0 = $outer;
                this.iterator = DropSequence.access$getSequence$p($outer).iterator();
                this.left = DropSequence.access$getCount$p($outer);
            }
