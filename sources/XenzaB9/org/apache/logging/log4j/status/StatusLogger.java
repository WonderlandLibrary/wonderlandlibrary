...
public final class StatusLogger extends AbstractLogger
{
    ...
    private StatusLogger(final String name, final MessageFactory messageFactory) {
        ...
        final Level loggerLevel = this.isDebugPropertyEnabled() ? Level.TRACE : Level.ERROR;
        this.logger = new SimpleLogger("StatusLogger", loggerLevel, false, true, showDateTime, false, dateFormat, messageFactory, StatusLogger.PROPS, System.err);
