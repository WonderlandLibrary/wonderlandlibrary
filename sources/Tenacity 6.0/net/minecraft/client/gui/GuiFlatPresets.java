...
public class GuiFlatPresets extends GuiScreen
{
    ...
    class ListSlot extends GuiSlot
    {
        ...
        public ListSlot() {
            super(GuiFlatPresets.this.mc2, GuiFlatPresets.this.width, GuiFlatPresets.this.height, 80, GuiFlatPresets.this.height - 37, 24);
        ...
        private void func_148171_c(final int p_148171_1_, final int p_148171_2_, final int p_148171_3_, final int p_148171_4_) {
            ...
            final double x = p_148171_1_ + 0;
            final double y = p_148171_2_ + 18;
            final GuiFlatPresets this$0 = GuiFlatPresets.this;
            worldRenderer.pos(x, y, GuiFlatPresets.zLevel).tex((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer2 = worldrenderer;
            final double x2 = p_148171_1_ + 18;
            final double y2 = p_148171_2_ + 18;
            final GuiFlatPresets this$2 = GuiFlatPresets.this;
            worldRenderer2.pos(x2, y2, GuiFlatPresets.zLevel).tex((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer3 = worldrenderer;
            final double x3 = p_148171_1_ + 18;
            final double y3 = p_148171_2_ + 0;
            final GuiFlatPresets this$3 = GuiFlatPresets.this;
            worldRenderer3.pos(x3, y3, GuiFlatPresets.zLevel).tex((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer4 = worldrenderer;
            final double x4 = p_148171_1_ + 0;
            final double y4 = p_148171_2_ + 0;
            final GuiFlatPresets this$4 = GuiFlatPresets.this;
            worldRenderer4.pos(x4, y4, GuiFlatPresets.zLevel).tex((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).endVertex();
            tessellator.draw();
        }
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            GuiFlatPresets.this.fontRendererObj.drawString(guiflatpresets$layeritem.field_148232_b, (float)(p_180791_2_ + 18 + 5), (float)(p_180791_3_ + 6), 16777215);
        }
    }
}
