...
public class GuiMerchant extends GuiContainer
{
    ...
    protected void drawGuiContainerForegroundLayer(final int mouseX, final int mouseY) {
        ...
        this.fontRendererObj.drawString(s, this.xSize / 2 - this.fontRendererObj.getStringWidth(s) / 2.0f, 6.0f, 4210752);
    ...
    public void updateScreen() {
        super.updateScreen();
        final MerchantRecipeList merchantrecipelist = this.merchant.getRecipes(this.mc2.thePlayer);
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        ...
        if (flag) {
            ...
            this.mc2.getNetHandler().addToSendQueue(new C17PacketCustomPayload("MC|TrSel", packetbuffer));
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        this.mc2.getTextureManager().bindTexture(GuiMerchant.MERCHANT_GUI_TEXTURE);
        final int i = (this.width - this.xSize) / 2;
        final int j = (this.height - this.ySize) / 2;
