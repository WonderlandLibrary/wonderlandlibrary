...
public class GuiSnooper extends GuiScreen
{
    ...
    public void initGui() {
        ...
        final boolean flag = this.mc2.getIntegratedServer() != null && this.mc2.getIntegratedServer().getPlayerUsageSnooper() != null;
        for (final Map.Entry<String, String> entry : new TreeMap<String, String>(this.mc2.getPlayerUsageSnooper().getCurrentStats()).entrySet()) {
        ...
        if (flag) {
            for (final Map.Entry<String, String> entry2 : new TreeMap<String, String>(this.mc2.getIntegratedServer().getPlayerUsageSnooper().getCurrentStats()).entrySet()) {
    ...
    class List extends GuiSlot
    {
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            GuiSnooper.this.fontRendererObj.drawString(GuiSnooper.this.field_146604_g.get(entryID), 10.0f, (float)p_180791_3_, 16777215);
            GuiSnooper.this.fontRendererObj.drawString(GuiSnooper.this.field_146609_h.get(entryID), 230.0f, (float)p_180791_3_, 16777215);
        }
