...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    public void updateScreen() {
        if (this.mc2.playerController.isInCreativeMode()) {
            this.mc2.displayGuiScreen(new GuiContainerCreative(this.mc2.thePlayer));
        }
    ...
    public void initGui() {
        ...
        if (this.mc2.playerController.isInCreativeMode()) {
            ...
            super.initGui();
            HUDMod.addButtons(this.buttonList);
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        this.mc2.getTextureManager().bindTexture(GuiInventory.inventoryBackground);
        final int i = this.guiLeft;
        final int j = this.guiTop;
        this.drawTexturedModalRect(i, j, 0, 0, this.xSize, this.ySize);
        drawEntityOnScreen(i + 51, j + 75, 30, i + 51 - this.oldMouseX, j + 75 - 50 - this.oldMouseY, this.mc2.thePlayer);
    }
