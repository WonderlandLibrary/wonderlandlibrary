...
public class GuiShaderOptions extends GuiScreenOF
{
    ...
    public void drawScreen(final int x, final int y, final float f) {
        ...
        if (this.screenText != null) {
            this.drawCenteredString(this.fontRendererObj, this.screenText, (float)(this.width / 2), 15, 16777215);
        }
        else {
            this.drawCenteredString(this.fontRendererObj, this.title, (float)(this.width / 2), 15, 16777215);
        }
