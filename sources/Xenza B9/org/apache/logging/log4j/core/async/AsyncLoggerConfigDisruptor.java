...
public class AsyncLoggerConfigDisruptor extends AbstractLifeCycle implements AsyncLoggerConfigDelegate
{
    ...
    public synchronized void start() {
        ...
        this.disruptor = (Disruptor<Log4jEventWrapper>)new Disruptor((EventFactory)this.factory, this.ringBufferSize, threadFactory, ProducerType.MULTI, this.waitStrategy);
        ...
        AsyncLoggerConfigDisruptor.LOGGER.debug("Starting AsyncLoggerConfig disruptor for this configuration with ringbufferSize={}, waitStrategy={}, exceptionHandler={}...", (Object)this.disruptor.getRingBuffer().getBufferSize(), this.waitStrategy.getClass().getSimpleName(), errorHandler);
