...
implements ViaPlatform<Player> {
    ...
    @Subscribe
    public void onProxyInit(ProxyInitializeEvent e2) {
    ...
    public void onProxyLateInit(ProxyInitializeEvent e2) {
    ...
    public JsonObject getDump() {
        ...
        while (iterator.hasNext()) {
            PluginContainer p2;
            plugins.add(new PluginInfo(true, p2.getDescription().getName().orElse(p2.getDescription().getId()), p2.getDescription().getVersion().orElse("Unknown Version"), (p2 = (PluginContainer)iterator.next()).getInstance().isPresent() ? p2.getInstance().get().getClass().getCanonicalName() : "Unknown", p2.getDescription().getAuthors()));
        }
