...
public class Mipmaps
{
    ...
    private int averageColor(final int i1, final int j1) {
        final int k = (i1 & 0xFF000000) >> 24 & 0xFF;
        final int l = (j1 & 0xFF000000) >> 24 & 0xFF;
        return (k + l >> 1 << 24) + ((i1 & 0xFEFEFE) + (j1 & 0xFEFEFE) >> 1);
    }
