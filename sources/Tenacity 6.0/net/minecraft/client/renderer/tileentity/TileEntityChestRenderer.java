...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest>
{
    ...
    public static boolean renderingInInventory;
    ...
    public void renderTileEntityAt(final TileEntityChest te, final double x, final double y, final double z, final float partialTicks, final int destroyStage) {
        ...
        if (te.adjacentChestZNeg == null && te.adjacentChestXNeg == null) {
            ...
            if (!TileEntityChestRenderer.renderingInInventory) {
                final RenderChestEvent renderChestEvent = new RenderChestEvent(te, modelchest::renderAll);
                Tenacity.INSTANCE.getEventProtocol().handleEvent(renderChestEvent);
    ...
    static {
        ...
        TileEntityChestRenderer.renderingInInventory = false;
    }
}
