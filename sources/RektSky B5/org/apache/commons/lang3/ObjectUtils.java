...
public class ObjectUtils {
    ...
    public static <T> T mode(T ... items) {
        if (ArrayUtils.isNotEmpty(items)) {
            ...
            Object result = null;
            int max = 0;
            for (Map.Entry e2 : occurrences.entrySet()) {
        ...
        if (obj instanceof Cloneable) {
            ...
            if (obj.getClass().isArray()) {
                ...
                try {
                    ...
                    throw new CloneFailedException("Cannot clone Cloneable type " + obj.getClass().getName(), e3);
                }
                catch (InvocationTargetException e4) {
                    throw new CloneFailedException("Exception cloning Cloneable type " + obj.getClass().getName(), e4.getCause());
                }
            }
