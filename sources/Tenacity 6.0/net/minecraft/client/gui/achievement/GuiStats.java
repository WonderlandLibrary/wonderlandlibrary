...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void initGui() {
        ...
        this.doesGuiPauseGame = true;
        this.mc2.getNetHandler().addToSendQueue(new C16PacketClientStatus(C16PacketClientStatus.EnumState.REQUEST_STATS));
    }
    ...
    public void func_175366_f() {
        (this.generalStats = new StatsGeneral(this.mc2)).registerScrollButtons(1, 1);
        (this.itemStats = new StatsItem(this.mc2)).registerScrollButtons(1, 1);
        (this.blockStats = new StatsBlock(this.mc2)).registerScrollButtons(1, 1);
        (this.mobStats = new StatsMobsList(this.mc2)).registerScrollButtons(1, 1);
    }
    ...
    private void drawSprite(final int p_146527_1_, final int p_146527_2_, final int p_146527_3_, final int p_146527_4_) {
        ...
        this.mc2.getTextureManager().bindTexture(GuiStats.statIcons);
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected void func_148209_a(final StatBase p_148209_1_, final int p_148209_2_, final int p_148209_3_, final boolean p_148209_4_) {
            if (p_148209_1_ != null) {
                ...
                final String s2 = "-";
                GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, (int)(p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth(s2)), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
            }
        }
            ...
            if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom) {
                ...
                if (i >= 0) {
                    ...
                    if (s.length() > 0) {
                        ...
                        final int i2 = (int)GuiStats.this.fontRendererObj.getStringWidth(s);
                        Gui.drawGradientRect(k - 3, l - 3, k + i2 + 3, l + 8 + 3, -1073741824, -1073741824);
        ...
        protected void func_148213_a(final StatCrafting p_148213_1_, final int p_148213_2_, final int p_148213_3_) {
            if (p_148213_1_ != null) {
                ...
                if (s2.length() > 0) {
                    ...
                    final int k = (int)GuiStats.this.fontRendererObj.getStringWidth(s2);
                    final GuiStats this$0 = GuiStats.this;
                    Gui.drawGradientRect(i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
