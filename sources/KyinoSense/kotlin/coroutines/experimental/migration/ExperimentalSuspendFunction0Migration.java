...
implements Function1<kotlin.coroutines.experimental.Continuation<? super R>, Object> {
    ...
    @Override
    @Nullable
    public Object invoke(@NotNull kotlin.coroutines.experimental.Continuation<? super R> continuation2) {
        Intrinsics.checkParameterIsNotNull(continuation2, "continuation");
        return this.function.invoke(CoroutinesMigrationKt.toContinuation(continuation2));
    }
