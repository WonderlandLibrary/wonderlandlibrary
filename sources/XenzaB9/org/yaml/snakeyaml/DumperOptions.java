...
public class DumperOptions
{
    ...
    public void setNonPrintableStyle(final NonPrintableStyle style) {
    ...
    public enum FlowStyle
    {
        ...
        @Deprecated
        public static FlowStyle fromBoolean(final Boolean flowStyle) {
            return (flowStyle == null) ? FlowStyle.AUTO : (flowStyle ? FlowStyle.FLOW : FlowStyle.BLOCK);
        }
