...
public class EntityEnderman extends EntityMob
{
    ...
    static class AIFindPlayer extends EntityAINearestAttackableTarget
    {
        ...
        public boolean shouldExecute() {
            ...
            final List<EntityPlayer> list = this.taskOwner.worldObj.getEntitiesWithinAABB((Class<? extends EntityPlayer>)EntityPlayer.class, this.taskOwner.getEntityBoundingBox().expand(d0, 4.0, d0), (com.google.common.base.Predicate<? super EntityPlayer>)this.targetEntitySelector);
