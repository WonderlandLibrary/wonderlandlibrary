    ...
    public void setLoadingProgress(final int progress) {
        if (!this.mc.running) {
            ...
            if (i - this.systemTime >= 100L) {
                ...
                this.mc.fontRendererObj.drawStringWithShadow(this.currentlyDisplayedText, (k - this.mc.fontRendererObj.getStringWidth(this.currentlyDisplayedText)) / 2.0f, (float)(l / 2 - 4 - 16), 16777215);
                this.mc.fontRendererObj.drawStringWithShadow(this.message, (k - this.mc.fontRendererObj.getStringWidth(this.message)) / 2.0f, (float)(l / 2 - 4 + 8), 16777215);
