...
public final class Charsets {
    ...
    public final Charset UTF32() {
        ...
        if (charset == null) {
            ...
            boolean bl = false;
            boolean bl2 = false;
            Charsets $this$run = charsets;
            boolean bl3 = false;
            Charset charset3 = Charset.forName("UTF-32");
            Intrinsics.checkExpressionValueIsNotNull(charset3, "Charset.forName(\"UTF-32\")");
    ...
    public final Charset UTF32_LE() {
        ...
        if (charset == null) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(charset3, "Charset.forName(\"UTF-32LE\")");
    ...
    public final Charset UTF32_BE() {
        ...
        if (charset == null) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(charset3, "Charset.forName(\"UTF-32BE\")");
    ...
    static {
        ...
        Intrinsics.checkExpressionValueIsNotNull(charset2, "Charset.forName(\"UTF-16\")");
        UTF_16 = charset2;
        Charset charset3 = Charset.forName("UTF-16BE");
        Intrinsics.checkExpressionValueIsNotNull(charset3, "Charset.forName(\"UTF-16BE\")");
        UTF_16BE = charset3;
        Charset charset4 = Charset.forName("UTF-16LE");
        Intrinsics.checkExpressionValueIsNotNull(charset4, "Charset.forName(\"UTF-16LE\")");
        UTF_16LE = charset4;
        Charset charset5 = Charset.forName("US-ASCII");
        Intrinsics.checkExpressionValueIsNotNull(charset5, "Charset.forName(\"US-ASCII\")");
        US_ASCII = charset5;
        Charset charset6 = Charset.forName("ISO-8859-1");
        Intrinsics.checkExpressionValueIsNotNull(charset6, "Charset.forName(\"ISO-8859-1\")");
        ISO_8859_1 = charset6;
    }
}
