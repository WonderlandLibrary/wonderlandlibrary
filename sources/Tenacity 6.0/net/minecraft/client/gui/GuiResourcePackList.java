...
public abstract class GuiResourcePackList extends GuiListExtended
{
    ...
    protected void drawListHeader(final int p_148129_1_, final int p_148129_2_, final Tessellator p_148129_3_) {
        final String s = EnumChatFormatting.UNDERLINE + "" + EnumChatFormatting.BOLD + this.getListHeader();
        this.mc.fontRendererObj.drawString(s, p_148129_1_ + this.width / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2.0f, (float)Math.min(this.top + 3, p_148129_2_), 16777215);
    }
