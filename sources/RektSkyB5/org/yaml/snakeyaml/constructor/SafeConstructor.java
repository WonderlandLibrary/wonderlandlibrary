    ...
    protected void processDuplicateKeys(MappingNode node) {
        ...
        for (NodeTuple tuple : nodeValue) {
            ...
            if (!keyNode.getTag().equals(Tag.MERGE)) {
                ...
                if ((prevIndex = keys.put(key, i2)) != null) {
    ...
    extends AbstractConstruct {
        ...
        public Object construct(Node node) {
            ...
            if (value.indexOf(58) != -1) {
                ...
                int bes = 1;
                double val2 = 0.0;
                int j2 = digits.length;
                for (int i2 = 0; i2 < j2; ++i2) {
                    val2 += Double.parseDouble(digits[j2 - i2 - 1]) * (double)bes;
                    bes *= 60;
                }
                return (double)sign * val2;
            }
            Double d2 = Double.valueOf(value);
            return d2 * (double)sign;
        }
    }
        ...
        public Object construct(Node node) {
            ...
            if (value.startsWith("0b")) {
                ...
                if (value.indexOf(58) != -1) {
                    ...
                    int j2 = digits.length;
                    for (int i2 = 0; i2 < j2; ++i2) {
                        val2 = (int)((long)val2 + Long.parseLong(digits[j2 - i2 - 1]) * (long)bes);
                        bes *= 60;
                    }
