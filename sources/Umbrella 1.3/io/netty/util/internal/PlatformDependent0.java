...
final class PlatformDependent0 {
    ...
    static {
        ...
        logger.debug("java.nio.ByteBuffer.cleaner: {}", (Object)(cleanerField != null ? "available" : "unavailable"));
        try {
        ...
        if (unsafe == null) {
            ...
            CLEANER_FIELD_OFFSET = PlatformDependent0.objectFieldOffset(cleanerField);
            try {
