...
import com.viaversion.viaversion.libs.javassist.bytecode.ByteStream;
...
public class ClassFileWriter {
    ...
    public static final class MethodWriter {
        ...
        public void add16(int b2) {
            this.output.writeShort(b2);
        }

        public void add32(int b2) {
            this.output.writeInt(b2);
        }
