...
public class SaveFormatOld implements ISaveFormat
{
    ...
    public SaveFormatOld(final File savesDirectoryIn) {
    ...
    public WorldInfo getWorldInfo(final String saveName) {
        ...
        if (file2.exists()) {
            try {
                ...
                SaveFormatOld.logger.error("Exception reading " + file2, (Throwable)exception1);
            }
        }
        ...
        if (file2.exists()) {
            try {
                ...
                SaveFormatOld.logger.error("Exception reading " + file2, (Throwable)exception2);
            }
        }
        return null;
    }
    ...
    public boolean deleteWorldDirectory(final String saveName) {
        ...
        SaveFormatOld.logger.info("Deleting level " + saveName);
        for (int i = 1; i <= 5; ++i) {
