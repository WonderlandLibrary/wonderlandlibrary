    ...
    public void renderPlayerlist(final int width, final Scoreboard scoreboardIn, final ScoreObjective scoreObjectiveIn) {
        ...
        if (this.header != null) {
            ...
            for (final String s : list2) {
                l4 = (int)Math.max((float)l4, this.mc.fontRendererObj.getStringWidth(s));
            }
        }
        if (this.footer != null) {
            list3 = this.mc.fontRendererObj.listFormattedStringToWidth(this.footer.getFormattedText(), width - 50);
            for (final String s2 : list3) {
                l4 = (int)Math.max((float)l4, this.mc.fontRendererObj.getStringWidth(s2));
            }
        }
        if (list2 != null) {
            ...
            for (final String s3 : list2) {
                final int i4 = (int)this.mc.fontRendererObj.getStringWidth(s3);
        ...
        for (int k3 = 0; k3 < l3; ++k3) {
            ...
            if (k3 < list.size()) {
                ...
                if (flag) {
                    ...
                    Gui.drawScaledCustomSizeModalRect((float)j4, (float)k4, 8.0f, (float)l6, 8.0f, (float)i6, 8.0f, 8.0f, 64.0f, 64.0f);
                    if (entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.HAT)) {
                        final int j5 = 8 + (flag2 ? 8 : 0);
                        final int k5 = 8 * (flag2 ? -1 : 1);
                        Gui.drawScaledCustomSizeModalRect((float)j4, (float)k4, 40.0f, (float)j5, 8.0f, (float)k5, 8.0f, 8.0f, 64.0f, 64.0f);
                    }
                    j4 += 9;
                }
        ...
        if (list3 != null) {
            ...
            for (final String s5 : list3) {
                final int j6 = (int)this.mc.fontRendererObj.getStringWidth(s5);
    ...
    private void drawScoreboardValues(final ScoreObjective p_175247_1_, final int p_175247_2_, final String p_175247_3_, final int p_175247_4_, final int p_175247_5_, final NetworkPlayerInfo p_175247_6_) {
        ...
        if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            if (j > 0) {
                ...
                if (f > 3.0f) {
                    for (int l = j; l < k; ++l) {
                        Gui.drawTexturedModalRect(p_175247_4_ + l * f, (float)p_175247_2_, flag ? 25 : 16, 0, 9, 9);
                    }
                    for (int j2 = 0; j2 < j; ++j2) {
                        Gui.drawTexturedModalRect(p_175247_4_ + j2 * f, (float)p_175247_2_, flag ? 25 : 16, 0, 9, 9);
                        if (flag) {
                            if (j2 * 2 + 1 < p_175247_6_.func_178860_m()) {
                                Gui.drawTexturedModalRect(p_175247_4_ + j2 * f, (float)p_175247_2_, 70, 0, 9, 9);
                            }
                            if (j2 * 2 + 1 == p_175247_6_.func_178860_m()) {
                                Gui.drawTexturedModalRect(p_175247_4_ + j2 * f, (float)p_175247_2_, 79, 0, 9, 9);
                            }
                        }
                        if (j2 * 2 + 1 < i) {
                            Gui.drawTexturedModalRect(p_175247_4_ + j2 * f, (float)p_175247_2_, (j2 >= 10) ? 160 : 52, 0, 9, 9);
                        }
                        if (j2 * 2 + 1 == i) {
                            Gui.drawTexturedModalRect(p_175247_4_ + j2 * f, (float)p_175247_2_, (j2 >= 10) ? 169 : 61, 0, 9, 9);
                        }
                    }
                }
                else {
                    ...
                    this.mc.fontRendererObj.drawStringWithShadow(s, (p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2.0f, (float)p_175247_2_, i2);
                }
            }
        }
        else {
            final String s2 = EnumChatFormatting.YELLOW + "" + i;
            this.mc.fontRendererObj.drawStringWithShadow(s2, p_175247_5_ - this.mc.fontRendererObj.getStringWidth(s2), (float)p_175247_2_, 16777215);
        }
    }
