...
implements Logger {
    ...
    public void catching(Level level, Throwable t2) {
        this.catching(FQCN, level, t2);
    }

    @Override
    public void catching(Throwable t2) {
        this.catching(FQCN, Level.ERROR, t2);
    }

    protected void catching(String fqcn, Level level, Throwable t2) {
        if (this.isEnabled(level, CATCHING_MARKER, (Object)null, null)) {
            this.log(CATCHING_MARKER, fqcn, level, this.messageFactory.newMessage(CATCHING), t2);
        }
    }
    ...
    @Override
    public void debug(Marker marker, Message msg, Throwable t2) {
        if (this.isEnabled(Level.DEBUG, marker, msg, t2)) {
            this.log(marker, FQCN, Level.DEBUG, msg, t2);
        }
    }
    ...
    @Override
    public void debug(Marker marker, Object message, Throwable t2) {
        if (this.isEnabled(Level.DEBUG, marker, message, t2)) {
            this.log(marker, FQCN, Level.DEBUG, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void debug(Marker marker, String message, Throwable t2) {
        if (this.isEnabled(Level.DEBUG, marker, message, t2)) {
            this.log(marker, FQCN, Level.DEBUG, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void debug(Message msg, Throwable t2) {
        if (this.isEnabled(Level.DEBUG, null, msg, t2)) {
            this.log(null, FQCN, Level.DEBUG, msg, t2);
        }
    }
    ...
    public void debug(Object message, Throwable t2) {
        if (this.isEnabled(Level.DEBUG, null, message, t2)) {
            this.log(null, FQCN, Level.DEBUG, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    public void debug(String message, Throwable t2) {
        if (this.isEnabled(Level.DEBUG, (Marker)null, message, t2)) {
            this.log(null, FQCN, Level.DEBUG, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void error(Marker marker, Message msg, Throwable t2) {
        if (this.isEnabled(Level.ERROR, marker, msg, t2)) {
            this.log(marker, FQCN, Level.ERROR, msg, t2);
        }
    }
    ...
    @Override
    public void error(Marker marker, Object message, Throwable t2) {
        if (this.isEnabled(Level.ERROR, marker, message, t2)) {
            this.log(marker, FQCN, Level.ERROR, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void error(Marker marker, String message, Throwable t2) {
        if (this.isEnabled(Level.ERROR, marker, message, t2)) {
            this.log(marker, FQCN, Level.ERROR, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void error(Message msg, Throwable t2) {
        if (this.isEnabled(Level.ERROR, null, msg, t2)) {
            this.log(null, FQCN, Level.ERROR, msg, t2);
        }
    }
    ...
    public void error(Object message, Throwable t2) {
        if (this.isEnabled(Level.ERROR, null, message, t2)) {
            this.log(null, FQCN, Level.ERROR, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    public void error(String message, Throwable t2) {
        if (this.isEnabled(Level.ERROR, (Marker)null, message, t2)) {
            this.log(null, FQCN, Level.ERROR, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void fatal(Marker marker, Message msg, Throwable t2) {
        if (this.isEnabled(Level.FATAL, marker, msg, t2)) {
            this.log(marker, FQCN, Level.FATAL, msg, t2);
        }
    }
    ...
    @Override
    public void fatal(Marker marker, Object message, Throwable t2) {
        if (this.isEnabled(Level.FATAL, marker, message, t2)) {
            this.log(marker, FQCN, Level.FATAL, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void fatal(Marker marker, String message, Throwable t2) {
        if (this.isEnabled(Level.FATAL, marker, message, t2)) {
            this.log(marker, FQCN, Level.FATAL, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void fatal(Message msg, Throwable t2) {
        if (this.isEnabled(Level.FATAL, null, msg, t2)) {
            this.log(null, FQCN, Level.FATAL, msg, t2);
        }
    }
    ...
    public void fatal(Object message, Throwable t2) {
        if (this.isEnabled(Level.FATAL, null, message, t2)) {
            this.log(null, FQCN, Level.FATAL, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    public void fatal(String message, Throwable t2) {
        if (this.isEnabled(Level.FATAL, (Marker)null, message, t2)) {
            this.log(null, FQCN, Level.FATAL, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void info(Marker marker, Message msg, Throwable t2) {
        if (this.isEnabled(Level.INFO, marker, msg, t2)) {
            this.log(marker, FQCN, Level.INFO, msg, t2);
        }
    }
    ...
    @Override
    public void info(Marker marker, Object message, Throwable t2) {
        if (this.isEnabled(Level.INFO, marker, message, t2)) {
            this.log(marker, FQCN, Level.INFO, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void info(Marker marker, String message, Throwable t2) {
        if (this.isEnabled(Level.INFO, marker, message, t2)) {
            this.log(marker, FQCN, Level.INFO, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void info(Message msg, Throwable t2) {
        if (this.isEnabled(Level.INFO, null, msg, t2)) {
            this.log(null, FQCN, Level.INFO, msg, t2);
        }
    }
    ...
    public void info(Object message, Throwable t2) {
        if (this.isEnabled(Level.INFO, null, message, t2)) {
            this.log(null, FQCN, Level.INFO, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    public void info(String message, Throwable t2) {
        if (this.isEnabled(Level.INFO, (Marker)null, message, t2)) {
            this.log(null, FQCN, Level.INFO, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void log(Level level, Marker marker, Message msg, Throwable t2) {
        if (this.isEnabled(level, marker, msg, t2)) {
            this.log(marker, FQCN, level, msg, t2);
        }
    }
    ...
    @Override
    public void log(Level level, Marker marker, Object message, Throwable t2) {
        if (this.isEnabled(level, marker, message, t2)) {
            this.log(marker, FQCN, level, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void log(Level level, Marker marker, String message, Throwable t2) {
        if (this.isEnabled(level, marker, message, t2)) {
            this.log(marker, FQCN, level, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void log(Level level, Message msg, Throwable t2) {
        if (this.isEnabled(level, null, msg, t2)) {
            this.log(null, FQCN, level, msg, t2);
        }
    }
    ...
    @Override
    public void log(Level level, Object message, Throwable t2) {
        if (this.isEnabled(level, null, message, t2)) {
            this.log(null, FQCN, level, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    public void log(Level level, String message, Throwable t2) {
        if (this.isEnabled(level, (Marker)null, message, t2)) {
            this.log(null, FQCN, level, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public <T extends Throwable> T throwing(Level level, T t2) {
        return this.throwing(FQCN, level, t2);
    }

    @Override
    public <T extends Throwable> T throwing(T t2) {
        return this.throwing(FQCN, Level.ERROR, t2);
    }

    protected <T extends Throwable> T throwing(String fqcn, Level level, T t2) {
        if (this.isEnabled(level, THROWING_MARKER, (Object)null, null)) {
            this.log(THROWING_MARKER, fqcn, level, this.messageFactory.newMessage(THROWING), t2);
        }
        return t2;
    }
    ...
    @Override
    public void trace(Marker marker, Message msg, Throwable t2) {
        if (this.isEnabled(Level.TRACE, marker, msg, t2)) {
            this.log(marker, FQCN, Level.TRACE, msg, t2);
        }
    }
    ...
    @Override
    public void trace(Marker marker, Object message, Throwable t2) {
        if (this.isEnabled(Level.TRACE, marker, message, t2)) {
            this.log(marker, FQCN, Level.TRACE, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void trace(Marker marker, String message, Throwable t2) {
        if (this.isEnabled(Level.TRACE, marker, message, t2)) {
            this.log(marker, FQCN, Level.TRACE, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void trace(Message msg, Throwable t2) {
        if (this.isEnabled(Level.TRACE, null, msg, t2)) {
            this.log(null, FQCN, Level.TRACE, msg, t2);
        }
    }
    ...
    public void trace(Object message, Throwable t2) {
        if (this.isEnabled(Level.TRACE, null, message, t2)) {
            this.log(null, FQCN, Level.TRACE, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    public void trace(String message, Throwable t2) {
        if (this.isEnabled(Level.TRACE, (Marker)null, message, t2)) {
            this.log(null, FQCN, Level.TRACE, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void warn(Marker marker, Message msg, Throwable t2) {
        if (this.isEnabled(Level.WARN, marker, msg, t2)) {
            this.log(marker, FQCN, Level.WARN, msg, t2);
        }
    }
    ...
    @Override
    public void warn(Marker marker, Object message, Throwable t2) {
        if (this.isEnabled(Level.WARN, marker, message, t2)) {
            this.log(marker, FQCN, Level.WARN, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void warn(Marker marker, String message, Throwable t2) {
        if (this.isEnabled(Level.WARN, marker, message, t2)) {
            this.log(marker, FQCN, Level.WARN, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    @Override
    public void warn(Message msg, Throwable t2) {
        if (this.isEnabled(Level.WARN, null, msg, t2)) {
            this.log(null, FQCN, Level.WARN, msg, t2);
        }
    }
    ...
    public void warn(Object message, Throwable t2) {
        if (this.isEnabled(Level.WARN, null, message, t2)) {
            this.log(null, FQCN, Level.WARN, this.messageFactory.newMessage(message), t2);
        }
    }
    ...
    public void warn(String message, Throwable t2) {
        if (this.isEnabled(Level.WARN, (Marker)null, message, t2)) {
            this.log(null, FQCN, Level.WARN, this.messageFactory.newMessage(message), t2);
        }
    }
}
