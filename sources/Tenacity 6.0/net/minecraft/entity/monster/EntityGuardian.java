...
public class EntityGuardian extends EntityMob
{
    ...
    protected void updateAITasks() {
        ...
        if (this.isElder()) {
            ...
            if ((this.ticksExisted + this.getEntityId()) % 1200 == 0) {
                ...
                for (final EntityPlayerMP entityplayermp : this.worldObj.getPlayers((Class<? extends EntityPlayerMP>)EntityPlayerMP.class, (com.google.common.base.Predicate<? super EntityPlayerMP>)new Predicate<EntityPlayerMP>() {
    ...
    protected void dropFewItems(final boolean wasRecentlyHit, final int lootingModifier) {
        final int i = this.rand.nextInt(3) + this.rand.nextInt(lootingModifier + 1);
        if (i > 0) {
