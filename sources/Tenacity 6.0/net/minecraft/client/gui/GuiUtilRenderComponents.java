...
public class GuiUtilRenderComponents
{
    ...
    public static List<IChatComponent> splitText(final IChatComponent p_178908_0_, final int p_178908_1_, final AbstractFontRenderer p_178908_2_, final boolean p_178908_3_, final boolean p_178908_4_) {
        int i = 0;
        ...
        for (int j = 0; j < list2.size(); ++j) {
            ...
            final String s3 = func_178909_a(ichatcomponent2.getChatStyle().getFormattingCode() + s, p_178908_4_);
            final String s4 = s3.endsWith("\n") ? s3.substring(0, s3.length() - 1) : s3;
            int i2 = (int)p_178908_2_.getStringWidth(s4);
            ...
            if (i + i2 > p_178908_1_) {
                ...
                if (s6 != null) {
                    ...
                    if (l >= 0 && p_178908_2_.getStringWidth(s3.substring(0, l)) > 0.0f) {
                        s5 = s3.substring(0, l);
                        if (p_178908_3_) {
                            ++l;
                        }
                    ...
                    s6 = IFontRenderer.getFormatFromString(s5) + s6;
                ...
                i2 = (int)p_178908_2_.getStringWidth(s5);
