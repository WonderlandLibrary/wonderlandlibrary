...
public class ClassReader {
        ...
        for (int i = 1; i < ll; ++i) {
            ...
            switch (tag2) {
                ...
                case 11: {
                    ...
                    item.set(tag2, this.readClass(index, buf), this.readUTF8(nameType, buf), this.readUTF8(nameType + 2, buf));
                    break;
                }
                case 3: {
                ...
                case 12: {
                    item.set(tag2, this.readUTF8(index, buf), this.readUTF8(index + 2, buf), null);
                    break;
                }
                case 5: {
                ...
                default: {
                    item.set(tag2, this.readUTF8(index, buf), null, null);
                }
            }
            ...
            switch (ClassWriter.TYPE[opcode]) {
                ...
                case 15: {
                    ...
                    for (int i5 = 0; i5 < len; ++i5) {
                        ...
                        values2[i5] = labels[offset + this.readInt(u + 4)];
                        u += 8;
                    }
                    mv.visitLookupSwitchInsn(labels[label], keys2, values2);
                    break;
                }
                case 3: {
    ...
    public Object readConst(int item, char[] buf) {
        ...
        return new Handle(tag2, owner, name, desc, itf);
    }
}
