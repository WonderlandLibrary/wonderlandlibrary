...
public class PlayerSelector
{
    ...
    public static <T extends Entity> List<T> matchEntities(final ICommandSender sender, final String token, final Class<? extends T> targetClass) {
        ...
        for (final World world : list) {
            if (world != null) {
                ...
                list3.addAll(getScorePredicates(map));
    ...
    private static List<Predicate<Entity>> getXpLevelPredicates(final Map<String, String> p_179648_0_) {
        final List<Predicate<Entity>> list = (List<Predicate<Entity>>)Lists.newArrayList();
    ...
    private static List<Predicate<Entity>> getGamemodePredicates(final Map<String, String> p_179649_0_) {
        final List<Predicate<Entity>> list = (List<Predicate<Entity>>)Lists.newArrayList();
    ...
    private static List<Predicate<Entity>> getTeamPredicates(final Map<String, String> p_179659_0_) {
        final List<Predicate<Entity>> list = (List<Predicate<Entity>>)Lists.newArrayList();
    ...
    private static List<Predicate<Entity>> getScorePredicates(final Map<String, String> p_179657_0_) {
        final List<Predicate<Entity>> list = (List<Predicate<Entity>>)Lists.newArrayList();
    ...
    private static List<Predicate<Entity>> getNamePredicates(final Map<String, String> p_179647_0_) {
        final List<Predicate<Entity>> list = (List<Predicate<Entity>>)Lists.newArrayList();
    ...
    private static List<Predicate<Entity>> getRotationsPredicates(final Map<String, String> p_179662_0_) {
        final List<Predicate<Entity>> list = (List<Predicate<Entity>>)Lists.newArrayList();
    ...
    private static <T extends Entity> List<T> filterResults(final Map<String, String> params, final Class<? extends T> entityClass, final List<Predicate<Entity>> inputList, final String type, final World worldIn, final BlockPos position) {
        ...
        final Predicate<Entity> predicate2 = (Predicate<Entity>)Predicates.and((Predicate)EntitySelectors.selectAnything, (Predicate)predicate);
        if (position != null) {
    ...
    private static <T extends Entity> List<T> func_179658_a(List<T> p_179658_0_, final Map<String, String> p_179658_1_, final ICommandSender p_179658_2_, final Class<? extends T> p_179658_3_, final String p_179658_4_, final BlockPos p_179658_5_) {
        ...
        if (entity != null && p_179658_3_.isAssignableFrom(entity.getClass()) && i == 1 && p_179658_0_.contains(entity) && !"r".equals(p_179658_4_)) {
            p_179658_0_ = (List<T>)Lists.newArrayList((Object[])new Entity[] { entity });
        }
        if (i != 0) {
            if (i < 0) {
