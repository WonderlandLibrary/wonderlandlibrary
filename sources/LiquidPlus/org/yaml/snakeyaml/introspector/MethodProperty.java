...
extends GenericProperty {
    ...
    public <A extends Annotation> A getAnnotation(Class<A> annotationType) {
        A annotation2 = null;
        if (this.isReadable()) {
            annotation2 = this.property.getReadMethod().getAnnotation(annotationType);
        }
        if (annotation2 == null && this.isWritable()) {
            annotation2 = this.property.getWriteMethod().getAnnotation(annotationType);
        }
        return annotation2;
    }
