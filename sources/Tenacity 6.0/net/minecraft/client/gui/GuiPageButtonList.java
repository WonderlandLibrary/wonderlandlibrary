...
public class GuiPageButtonList extends GuiListExtended
{
    ...
    private void func_178069_s() {
        for (final GuiListEntry[] aguipagebuttonlist$guilistentry : this.field_178078_x) {
    ...
    private void func_178060_e(final int p_178060_1_, final int p_178060_2_) {
        for (final GuiListEntry guipagebuttonlist$guilistentry : this.field_178078_x[p_178060_1_]) {
        ...
        for (final GuiListEntry guipagebuttonlist$guilistentry2 : this.field_178078_x[p_178060_2_]) {
        ...
        if (this.field_178075_A instanceof GuiTextField) {
            ...
            if (!GuiScreen.isKeyComboCtrlV(p_178062_2_)) {
                if (p_178062_2_ == 15) {
                    ...
                    final float l = guitextfield.yPosition + this.slotHeight;
                    final float i1 = guitextfield.yPosition;
                    if (l > this.bottom) {
    ...
    public static class EditBoxEntry extends GuiListEntry
    {
        ...
        public EditBoxEntry(final int p_i45534_1_, final String p_i45534_2_, final boolean p_i45534_3_, final Predicate<String> p_i45534_4_) {
            ...
            this.field_178951_a = (Predicate<String>)MoreObjects.firstNonNull((Object)p_i45534_4_, (Object)Predicates.alwaysTrue());
        }
    ...
    public static class GuiEntry implements IGuiListEntry
    {
        ...
        private void func_178027_a(final GuiTextField p_178027_1_, final int p_178027_2_, final boolean p_178027_3_) {
            p_178027_1_.yPosition = (float)p_178027_2_;
            if (!p_178027_3_) {
