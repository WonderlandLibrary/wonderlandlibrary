                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        for (int i2 = 0; i2 < blockTagsSize; ++i2) {
                            ...
                            for (int j2 = 0; j2 < blockIds.length; ++j2) {
                                blockIds[j2] = Protocol1_14To1_13_2.this.getMappingData().getNewBlockId(blockIds[j2]);
                            }
                        }
                        ...
                        for (int i3 = 0; i3 < itemTagsSize; ++i3) {
                            ...
                            for (int j3 = 0; j3 < itemIds.length; ++j3) {
                                itemIds[j3] = Protocol1_14To1_13_2.this.getMappingData().getNewItemId(itemIds[j3]);
                            }
                        }
                        wrapper.write(Type.STRING, "minecraft:signs");
