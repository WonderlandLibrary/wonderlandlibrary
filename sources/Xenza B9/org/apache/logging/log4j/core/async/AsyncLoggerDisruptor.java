...
class AsyncLoggerDisruptor extends AbstractLifeCycle
{
    ...
    public synchronized void start() {
        ...
        final AsyncWaitStrategyFactory factory = this.waitStrategyFactorySupplier.get();
        ...
        this.disruptor = (Disruptor<RingBufferLogEvent>)new Disruptor((EventFactory)RingBufferLogEvent.FACTORY, this.ringBufferSize, threadFactory, ProducerType.MULTI, this.waitStrategy);
        ...
        AsyncLoggerDisruptor.LOGGER.debug("[{}] Starting AsyncLogger disruptor for this context with ringbufferSize={}, waitStrategy={}, exceptionHandler={}...", this.contextName, this.disruptor.getRingBuffer().getBufferSize(), this.waitStrategy.getClass().getSimpleName(), errorHandler);
