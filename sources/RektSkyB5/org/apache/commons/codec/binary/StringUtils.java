...
public class StringUtils {
    ...
    public static byte[] getBytesUnchecked(String string, String charsetName) {
        ...
        try {
            ...
            throw StringUtils.newIllegalStateException(charsetName, e2);
        }
    }
    ...
    private static IllegalStateException newIllegalStateException(String charsetName, UnsupportedEncodingException e2) {
        return new IllegalStateException(charsetName + ": " + e2);
    }
