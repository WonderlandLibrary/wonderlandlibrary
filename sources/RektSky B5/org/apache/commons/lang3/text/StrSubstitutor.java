            ...
            while (pos < bufEnd) {
                ...
                if (nestedVarCount == 0) {
                    ...
                    if (valueDelimMatcher != null) {
                        ...
                        for (int i2 = 0; i2 < varNameExprChars.length && (substitutionInVariablesEnabled || pfxMatcher.isMatch(varNameExprChars, i2, i2, varNameExprChars.length) == 0); ++i2) {
                            valueDelimiterMatchLen = valueDelimMatcher.isMatch(varNameExprChars, i2);
                            if (valueDelimiterMatchLen == 0) continue;
                            varName = varNameExpr.substring(0, i2);
                            varDefaultValue = varNameExpr.substring(i2 + valueDelimiterMatchLen);
                            break;
                        }
                    }
