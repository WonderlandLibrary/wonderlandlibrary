...
implements Serializable {
    ...
    public static Matrix4f setIdentity(Matrix4f m2) {
        m2.m00 = 1.0f;
        m2.m01 = 0.0f;
        m2.m02 = 0.0f;
        m2.m03 = 0.0f;
    ...
    public static Matrix4f setZero(Matrix4f m2) {
        m2.m00 = 0.0f;
        m2.m01 = 0.0f;
        m2.m02 = 0.0f;
        m2.m03 = 0.0f;
    ...
    public static Vector4f transform(Matrix4f left, Vector4f right, Vector4f dest) {
        ...
        float x2 = left.m00 * right.x + left.m10 * right.y + left.m20 * right.z + left.m30 * right.w;
        float y2 = left.m01 * right.x + left.m11 * right.y + left.m21 * right.z + left.m31 * right.w;
        float z2 = left.m02 * right.x + left.m12 * right.y + left.m22 * right.z + left.m32 * right.w;
        float w2 = left.m03 * right.x + left.m13 * right.y + left.m23 * right.z + left.m33 * right.w;
        dest.x = x2;
        dest.y = y2;
        dest.z = z2;
        dest.w = w2;
    ...
    public static Matrix4f rotate(float angle, Vector3f axis, Matrix4f src, Matrix4f dest) {
        ...
        float ys = axis.y * s2;
        float zs = axis.z * s2;
        float f00 = axis.x * axis.x * oneminusc + c2;
        float f01 = xy * oneminusc + zs;
        float f02 = xz * oneminusc - ys;
        float f10 = xy * oneminusc - zs;
        float f11 = axis.y * axis.y * oneminusc + c2;
        float f12 = yz * oneminusc + xs;
        float f20 = xz * oneminusc + ys;
        float f21 = yz * oneminusc - xs;
        float f22 = axis.z * axis.z * oneminusc + c2;
