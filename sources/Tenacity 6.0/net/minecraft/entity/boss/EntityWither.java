...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
    ...
    public void onLivingUpdate() {
        ...
        for (int j = 0; j < 2; ++j) {
            ...
            if (entity2 != null) {
                ...
                final float f = (float)(MathHelper.atan2(d10, d8) * 180.0 / 3.141592653589793) - 90.0f;
                final float f2 = (float)(-(MathHelper.atan2(d9, d11) * 180.0 / 3.141592653589793));
    ...
    public static boolean canDestroyBlock(final Block p_181033_0_) {
    ...
    @Override
    public void attackEntityWithRangedAttack(final EntityLivingBase target, final float p_82196_2_) {
