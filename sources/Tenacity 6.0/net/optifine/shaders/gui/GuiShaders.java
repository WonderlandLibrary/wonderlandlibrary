...
public class GuiShaders extends GuiScreenOF
{
            ...
            if (!(button instanceof GuiButtonEnumShaderOption)) {
                    ...
                    switch (button.id) {
                        case 201: {
                            ...
                            try {
                                ...
                                oclass1.getMethod("browse", URI.class).invoke(object1, new File(this.mc2.mcDataDir, "shaderpacks").toURI());
                            }
                        ...
                        case 202: {
                            Shaders.storeConfig();
                            this.saved = true;
                            this.mc2.displayGuiScreen(this.parentGui);
                            return;
                        }
                        case 203: {
                ...
                switch (guibuttonenumshaderoption.getEnumShaderOption()) {
                    ...
                    case NORMAL_MAP: {
                        ...
                        Shaders.uninit();
                        this.mc2.scheduleResourcesRefresh();
                        break;
                    }
                    case SPECULAR_MAP: {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final int i = (int)this.fontRendererObj.getStringWidth(s);
        if (i < this.width - 5) {
