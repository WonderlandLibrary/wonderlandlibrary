...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    private int func_177077_a(final EntityItem itemIn, final double p_177077_2_, final double p_177077_4_, final double p_177077_6_, final float p_177077_8_, final IBakedModel p_177077_9_) {
        ...
        final boolean itemPhysics = Tenacity.INSTANCE.isEnabled(ItemPhysics.class);
        ...
        final float f = 0.25f;
        final float f2 = itemPhysics ? -0.13f : (MathHelper.sin((itemIn.getAge() + p_177077_8_) / 10.0f + itemIn.hoverStart) * 0.1f + 0.1f);
        ...
        if (flag || this.renderManager.options != null) {
            ...
            if (itemPhysics) {
                if (itemIn.onGround) {
                    final double var = (itemIn.posX + itemIn.motionX * mc.timer.renderPartialTicks) * 200.0 + (itemIn.posZ + itemIn.motionZ * mc.timer.renderPartialTicks) * 200.0;
                    ...
                    final double x = (itemIn.posX + itemIn.motionX * mc.timer.renderPartialTicks) * 200.0;
                    final double y = (itemIn.posY + itemIn.motionY * mc.timer.renderPartialTicks) * 200.0;
                    final double z = (itemIn.posZ + itemIn.motionZ * mc.timer.renderPartialTicks) * 200.0;
