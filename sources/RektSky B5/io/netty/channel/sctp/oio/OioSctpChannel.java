...
implements SctpChannel {
    ...
    protected SocketAddress localAddress0() {
        try {
            Iterator<SocketAddress> i2 = this.ch.getAllLocalAddresses().iterator();
            if (i2.hasNext()) {
                return i2.next();
            }
        }
    ...
    protected SocketAddress remoteAddress0() {
        try {
            Iterator<SocketAddress> i2 = this.ch.getRemoteAddresses().iterator();
            if (i2.hasNext()) {
                return i2.next();
            }
        }
    ...
    private static void closeSelector(String selectorName, Selector selector) {
        try {
            ...
            logger.warn("Failed to close a " + selectorName + " selector.", e2);
        }
    }
