...
public class SyslogAppender extends SocketAppender
{
    ...
    public static class Builder<B extends Builder<B>> extends AbstractBuilder<B> implements org.apache.logging.log4j.core.util.Builder<SocketAppender>
    {
        ...
        public SyslogAppender build() {
            ...
            final AbstractSocketManager manager = SocketAppender.createSocketManager(name, protocol, this.getHost(), this.getPort(), this.getConnectTimeoutMillis(), sslConfiguration, this.getReconnectDelayMillis(), this.getImmediateFail(), layout, Constants.ENCODER_BYTE_BUFFER_SIZE, this.getSocketOptions());
