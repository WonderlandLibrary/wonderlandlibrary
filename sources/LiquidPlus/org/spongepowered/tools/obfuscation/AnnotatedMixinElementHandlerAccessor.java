...
implements IMixinContext {
    ...
    extends AnnotatedElementAccessor {
        public AnnotatedElementInvoker(ExecutableElement element, AnnotationHandle annotation2, boolean shouldRemap) {
            super(element, annotation2, shouldRemap);
        }
    ...
    extends AnnotatedMixinElementHandler.AnnotatedElement<ExecutableElement> {
        ...
        public AnnotatedElementAccessor(ExecutableElement element, AnnotationHandle annotation2, boolean shouldRemap) {
