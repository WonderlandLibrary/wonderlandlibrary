...
public final class UScript {
    ...
    public static final boolean hasScript(int c2, int sc) {
        int scriptX = UCharacterProperty.INSTANCE.getAdditional(c2, 0) & 0xC000FF;
        if (scriptX < 0x400000) {
            return sc == scriptX;
        }
    ...
    public static final int getScriptExtensions(int c2, BitSet set) {
        char sx;
        set.clear();
        int scriptX = UCharacterProperty.INSTANCE.getAdditional(c2, 0) & 0xC000FF;
        if (scriptX < 0x400000) {
