...
public class GuiRepair extends GuiContainer implements ICrafting
{
    ...
    protected void drawGuiContainerForegroundLayer(final int mouseX, final int mouseY) {
        ...
        if (this.anvil.maximumCost > 0) {
            ...
            if (this.anvil.maximumCost >= 40 && !this.mc2.thePlayer.capabilities.isCreativeMode) {
            ...
            if (flag) {
                ...
                final int k = (int)(this.xSize - 8 - this.fontRendererObj.getStringWidth(s));
                final int l = 67;
    ...
    private void renameItem() {
        ...
        this.mc2.thePlayer.sendQueue.addToSendQueue(new C17PacketCustomPayload("MC|ItemName", new PacketBuffer(Unpooled.buffer()).writeString(s)));
    }
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        this.mc2.getTextureManager().bindTexture(GuiRepair.anvilResource);
        final int i = (this.width - this.xSize) / 2;
        final int j = (this.height - this.ySize) / 2;
    ...
    @Override
    public void sendAllWindowProperties(final Container p_175173_1_, final IInventory p_175173_2_) {
    }
