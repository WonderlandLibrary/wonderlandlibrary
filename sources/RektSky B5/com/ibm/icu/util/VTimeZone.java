        ...
        if (!hasTransitions) {
            ...
            if (dstCount > 0) {
                if (finalDstRule == null) {
                    ...
                    if (nextStart != null) {
                        VTimeZone.writeFinalRule(w2, true, finalDstRule, dstFromOffset - dstFromDSTSavings, dstFromDSTSavings, nextStart.getTime());
                    }
                }
            }
            if (stdCount > 0) {
                if (finalStdRule == null) {
                    ...
                    assert (nextStart != null);
                    if (nextStart != null) {
                        VTimeZone.writeFinalRule(w2, false, finalStdRule, stdFromOffset - stdFromDSTSavings, stdFromDSTSavings, nextStart.getTime());
                    }
                }
            }
        }
