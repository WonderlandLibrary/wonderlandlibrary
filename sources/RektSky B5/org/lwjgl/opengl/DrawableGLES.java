...
implements DrawableLWJGL {
    ...
    public void initContext(float r2, float g2, float b2) {
        GLES20.glClearColor((float)r2, (float)g2, (float)b2, (float)0.0f);
    ...
    public void destroy() {
        ...
        synchronized (object) {
            try {
                ...
                LWJGLUtil.log("Exception occurred while destroying Drawable: " + e3);
            }
        }
    }
