...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void onUpdate() {
        if (Minecraft.getMinecraft().theWorld.getBlockState(new BlockPos(this.posX, this.posY - 1.0, this.posZ)).getBlock() == Blocks.air) {
            ++this.airTicks;
        }
        else {
            this.airTicks = 0;
    ...
    public boolean interactWith(final Entity targetEntity) {
        if (this.isSpectator()) {
            ...
            if (f > 0.0f || f2 > 0.0f) {
                ...
                if (flag3) {
                    if (i > 0) {
                        ...
                        final KeepSprintEvent keepSprintEvent = new KeepSprintEvent();
    ...
    public void wakeUpPlayer(final boolean immediately, final boolean updateWorldFlag, final boolean setSpawn) {
        ...
        if (this.playerLocation != null && iblockstate.getBlock() == Blocks.bed) {
            this.worldObj.setBlockState(this.playerLocation, iblockstate.withProperty((IProperty<Comparable>)BlockBed.OCCUPIED, Boolean.FALSE), 4);
