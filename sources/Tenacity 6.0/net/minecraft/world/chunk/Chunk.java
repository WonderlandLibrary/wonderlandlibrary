...
public class Chunk
{
    ...
    public void populateChunk(final IChunkProvider p_76624_1_, final IChunkProvider p_76624_2_, final int x, final int z) {
        ...
        final boolean flag2 = p_76624_1_.chunkExists(x + 1, z);
        final boolean flag3 = p_76624_1_.chunkExists(x, z + 1);
        final boolean flag4 = p_76624_1_.chunkExists(x - 1, z);
        ...
        final boolean flag8 = p_76624_1_.chunkExists(x + 1, z - 1);
        ...
        if (flag && flag2 && flag8) {
            final Chunk chunk2 = p_76624_1_.provideChunk(x, z - 1);
            if (!chunk2.isTerrainPopulated) {
                p_76624_1_.populate(p_76624_2_, x, z - 1);
            }
            else {
                p_76624_1_.populateChunk(p_76624_2_, chunk2, x, z - 1);
            }
        }
        if (flag5 && flag && flag4) {
            final Chunk chunk3 = p_76624_1_.provideChunk(x - 1, z - 1);
            if (!chunk3.isTerrainPopulated) {
                p_76624_1_.populate(p_76624_2_, x - 1, z - 1);
            }
            else {
                p_76624_1_.populateChunk(p_76624_2_, chunk3, x - 1, z - 1);
            }
        }
    }
