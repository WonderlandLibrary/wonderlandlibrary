...
implements CommandCallable {
    ...
    public List<String> getSuggestions(CommandSource commandSource, String s2, @Nullable Location<World> location) throws CommandException {
        return this.getSuggestions(commandSource, s2);
    }
