...
implements DisplayImplementation {
    ...
    public void createWindow(DrawableLWJGL drawable, DisplayMode mode, Canvas parent, int x2, int y2) throws LWJGLException {
        ...
        this.hwnd = WindowsDisplay.nCreateWindow(x2, y2, mode.getWidth(), mode.getHeight(), Display.isFullscreen() || WindowsDisplay.isUndecorated(), parent != null, this.parent_hwnd);
