...
import shadersmod.common.SMCLog.1;
...
public abstract class SMCLog {
   ...
   public static final Level SMCINFO = new SMCLog.SMCLevel("INF", 850, (1)null);
   public static final Level SMCCONFIG = new SMCLog.SMCLevel("CFG", 840, (1)null);
   public static final Level SMCFINE = new SMCLog.SMCLevel("FNE", 830, (1)null);
   public static final Level SMCFINER = new SMCLog.SMCLevel("FNR", 820, (1)null);
   public static final Level SMCFINEST = new SMCLog.SMCLevel("FNT", 810, (1)null);
   ...
   private static class SMCLevel extends Level {
      ...
      // $FF: synthetic method
      SMCLevel(String x0, int x1, 1 x2) {
         this(x0, x1);
      }
   }
   ...
   private static class SMCLogger extends Logger {
      SMCLogger(String name) {
         ...
         final Formatter formatter = new SMCLog.SMCFormatter((1)null);
