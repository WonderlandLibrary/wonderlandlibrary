...
extends BaseConstructor {
    ...
    protected void processDuplicateKeys(MappingNode node) {
        ...
        for (NodeTuple tuple : nodeValue) {
            ...
            if (!keyNode.getTag().equals(Tag.MERGE)) {
                ...
                if ((prevIndex = keys2.put(key, i)) != null) {
    ...
    private List<NodeTuple> mergeNode(MappingNode node, boolean isPreffered, Map<Object, Integer> key2index, List<NodeTuple> values2) {
        ...
        block4: while (iter.hasNext()) {
            ...
            if (keyNode.getTag().equals(Tag.MERGE)) {
                ...
                switch (valueNode.getNodeId()) {
                    case mapping: {
                        ...
                        this.mergeNode(mn, false, key2index, values2);
                        break;
                    }
                    case sequence: {
                        ...
                        for (Node subnode : vals) {
                            ...
                            this.mergeNode(mnode, false, key2index, values2);
                        }
                        continue block4;
                    }
                    default: {
            ...
            if (!key2index.containsKey(key)) {
                values2.add(nodeTuple);
                key2index.put(key, values2.size() - 1);
                continue;
            }
            if (!isPreffered) continue;
            values2.set(key2index.get(key), nodeTuple);
        }
        return values2;
    }
