...
extends ConnectionHandler {
    ...
    private static short getStates(StairData stairData) {
        ...
        s2 = (short)(s2 | stairData.getShape() << 1);
        s2 = (short)(s2 | stairData.getType() << 4);
        s2 = (short)(s2 | stairData.getFacing().ordinal() << 9);
        return s2;
    }
    ...
    public int connect(UserConnection user, Position position, int blockState) {
        ...
        s2 = (short)(s2 | stairData.getType() << 4);
        Integer newBlockState = connectedBlocks.get(s2 = (short)(s2 | stairData.getFacing().ordinal() << 9));
