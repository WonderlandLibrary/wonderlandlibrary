...
public class ArrayUtils {
    ...
    public static void reverse(boolean[] array, int startIndexInclusive, int endIndexExclusive) {
        ...
        int i2 = startIndexInclusive < 0 ? 0 : startIndexInclusive;
    ...
    public static void shift(boolean[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
        ...
        while (n2 > 1 && offset > 0) {
            int n_offset = n2 - offset;
            if (offset > n_offset) {
                ArrayUtils.swap(array, startIndexInclusive, startIndexInclusive + n2 - n_offset, n_offset);
                n2 = offset;
                offset -= n_offset;
                continue;
            }
    ...
    public static Character[] toObject(char[] array) {
        ...
        for (int i2 = 0; i2 < array.length; ++i2) {
            result[i2] = Character.valueOf(array[i2]);
        }
        return result;
    }
    ...
    public static Float[] toObject(float[] array) {
        ...
        Float[] result = new Float[array.length];
        for (int i2 = 0; i2 < array.length; ++i2) {
            result[i2] = Float.valueOf(array[i2]);
        }
        return result;
    }
    ...
    public static Boolean[] toObject(boolean[] array) {
        ...
        Boolean[] result = new Boolean[array.length];
        for (int i2 = 0; i2 < array.length; ++i2) {
            result[i2] = array[i2] ? Boolean.TRUE : Boolean.FALSE;
        }
        return result;
    }
    ...
    public static char[] removeElements(char[] array, char ... values) {
        ...
        for (char v2 : values) {
            Character boxed = Character.valueOf(v2);
            MutableInt count = (MutableInt)occurrences.get(boxed);
            if (count == null) {
                occurrences.put(boxed, new MutableInt(1));
                continue;
    ...
    public static String[] toStringArray(Object[] array, String valueForNullElements) {
        ...
        for (int i2 = 0; i2 < array.length; ++i2) {
            Object object = array[i2];
            result[i2] = object == null ? valueForNullElements : object.toString();
        }
        return result;
    }
