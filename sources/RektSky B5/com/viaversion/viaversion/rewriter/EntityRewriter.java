...
implements com.viaversion.viaversion.api.rewriter.EntityRewriter<T> {
        ...
        for (Metadata metadata : metadataList.toArray(EMPTY_ARRAY)) {
            ...
            for (MetaFilter filter : this.metadataFilters) {
                ...
                try {
                    ...
                    this.logException(e2, type, metadataList, metadata);
                    metadataList.remove(i2--);
                    break;
                }
    ...
    private void logException(Exception e2, @Nullable EntityType type, List<Metadata> metadataList, Metadata metadata) {
