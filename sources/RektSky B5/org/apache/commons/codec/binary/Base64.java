...
extends BaseNCodec {
    ...
    void encode(byte[] in, int inPos, int inAvail, BaseNCodec.Context context) {
        ...
        if (inAvail < 0) {
            ...
            for (int i2 = 0; i2 < inAvail; ++i2) {
                ...
                context.ibitWorkArea = (context.ibitWorkArea << 8) + b2;
    ...
    void decode(byte[] in, int inPos, int inAvail, BaseNCodec.Context context) {
        ...
        for (int i2 = 0; i2 < inAvail; ++i2) {
            ...
            if ((b2 = in[inPos++]) == this.pad) {
                context.eof = true;
                break;
            }
            if (b2 < 0 || b2 >= DECODE_TABLE.length || (result = DECODE_TABLE[b2]) < 0) continue;
    ...
    public static boolean isBase64(byte[] arrayOctet) {
        for (int i2 = 0; i2 < arrayOctet.length; ++i2) {
            if (Base64.isBase64(arrayOctet[i2]) || Base64.isWhiteSpace(arrayOctet[i2])) continue;
            return false;
        }
        return true;
    }
