...
public class AnnotationUtils {
    ...
    public static boolean equals(Annotation a1, Annotation a2) {
        ...
        try {
            for (Method m2 : type.getDeclaredMethods()) {
                ...
                Object v1 = m2.invoke(a1, new Object[0]);
                Object v2 = m2.invoke(a2, new Object[0]);
    ...
    public static int hashCode(Annotation a2) {
        ...
        for (Method m2 : type.getDeclaredMethods()) {
            try {
                Object value = m2.invoke(a2, new Object[0]);
                if (value == null) {
    ...
    public static String toString(Annotation a2) {
        ...
        for (Method m2 : a2.annotationType().getDeclaredMethods()) {
            ...
            try {
                builder.append(m2.getName(), m2.invoke(a2, new Object[0]));
            }
            catch (RuntimeException ex) {
                throw ex;
            }
