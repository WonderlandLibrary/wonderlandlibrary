...
extends TimeZoneRule {
    ...
    public Date getNextStart(long base, int prevRawOffset, int prevDSTSavings, boolean inclusive) {
        ...
        Date d2 = this.getStartInYear(year, prevRawOffset, prevDSTSavings);
        if (d2 != null && (d2.getTime() < base || !inclusive && d2.getTime() == base)) {
            d2 = this.getStartInYear(year + 1, prevRawOffset, prevDSTSavings);
        }
        return d2;
    }
