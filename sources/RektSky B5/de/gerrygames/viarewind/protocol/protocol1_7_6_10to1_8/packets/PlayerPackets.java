    ...
    public static void register(Protocol1_7_6_10TO1_8 protocol) {
        ...
        protocol.registerClientbound(ClientboundPackets1_8.PLAYER_POSITION, new PacketRemapper(){
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if ((flags & 1) == 1) {
                        double x2 = packetWrapper.get(Type.DOUBLE, 0);
                        packetWrapper.set(Type.DOUBLE, 0, x2 += playerPosition.getPosX());
                    }
                    double y2 = packetWrapper.get(Type.DOUBLE, 1);
                    if ((flags & 2) == 2) {
                        y2 += playerPosition.getPosY();
                    }
                    playerPosition.setReceivedPosY(y2);
                    packetWrapper.set(Type.DOUBLE, 1, y2 += (double)1.62f);
                    if ((flags & 4) == 4) {
                        double z2 = packetWrapper.get(Type.DOUBLE, 2);
                        packetWrapper.set(Type.DOUBLE, 2, z2 += playerPosition.getPosZ());
                    }
                    if ((flags & 8) == 8) {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (gamemode == 3 || tracker.getGamemode() == 3) {
                        ...
                        for (int i2 = 1; i2 < 5; ++i2) {
                            ...
                            setSlot.write(Type.SHORT, (short)(9 - i2));
                            setSlot.write(Types1_7_6_10.COMPRESSED_NBT_ITEM, equipment[i2]);
        ...
        protocol.registerServerbound(ServerboundPackets1_7.PLAYER_POSITION, new PacketRemapper(){
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    playerPosition.setOnGround(packetWrapper.get(Type.BOOLEAN, 0));
                    playerPosition.setPos(x2, feetY, z2);
                });
            }
        });
        ...
        protocol.registerServerbound(ServerboundPackets1_7.PLAYER_DIGGING, new PacketRemapper(){
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    int x2 = packetWrapper.read(Type.INT);
                    short y2 = packetWrapper.read(Type.UNSIGNED_BYTE);
                    int z2 = packetWrapper.read(Type.INT);
                    packetWrapper.write(Type.POSITION, new Position(x2, y2, z2));
                });
            }
        });
        ...
        protocol.registerServerbound(ServerboundPackets1_7.UPDATE_SIGN, new PacketRemapper(){
            ...
            public void registerMap() {
                this.handler(packetWrapper -> {
                    int x2 = packetWrapper.read(Type.INT);
                    short y2 = packetWrapper.read(Type.SHORT);
                    int z2 = packetWrapper.read(Type.INT);
                    packetWrapper.write(Type.POSITION, new Position(x2, y2, z2));
                        ...
                        case "MC|BSign": {
                            ...
                            if (tag != null && tag.contains("pages")) {
                                ...
                                for (int i2 = 0; i2 < pages.size(); ++i2) {
                                    StringTag page = (StringTag)pages.get(i2);
