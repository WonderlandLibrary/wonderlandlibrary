...
public final class Iterables
{
    ...
    public static boolean elementsEqual(final Iterable<?> iterable1, final Iterable<?> iterable2) {
        if (iterable1 instanceof Collection && iterable2 instanceof Collection) {
            final Collection<?> collection1 = (Collection)iterable1;
            final Collection<?> collection2 = (Collection)iterable2;
    ...
    private static <E> Collection<E> toCollection(final Iterable<E> iterable) {
        return (iterable instanceof Collection) ? ((Collection)iterable) : Lists.newArrayList((Iterator<?>)iterable.iterator());
    }
