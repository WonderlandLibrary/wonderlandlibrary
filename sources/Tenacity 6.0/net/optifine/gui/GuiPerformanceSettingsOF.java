...
public class GuiPerformanceSettingsOF extends GuiScreen
{
    ...
    protected void actionPerformed(final GuiButton guibutton) {
        if (guibutton.enabled) {
            ...
            if (guibutton.id == 200) {
                ...
                this.mc2.displayGuiScreen(this.prevScreen);
            }
        }
    }
    ...
    static {
        GuiPerformanceSettingsOF.enumOptions = new GameSettings.Options[] { GameSettings.Options.SMOOTH_FPS, GameSettings.Options.SMOOTH_WORLD, GameSettings.Options.FAST_MATH, GameSettings.Options.CHUNK_UPDATES, GameSettings.Options.CHUNK_UPDATES_DYNAMIC, GameSettings.Options.RENDER_REGIONS, GameSettings.Options.LAZY_CHUNK_LOADING, GameSettings.Options.SMART_ANIMATIONS };
    }
}
