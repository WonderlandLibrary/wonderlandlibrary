...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        if (!this.initialized) {
            ...
            (this.savedServerList = new ServerList(this.mc2)).loadServerList();
            ...
            (this.serverListSelector = new ServerSelectionList(this, this.mc2, this.width, this.height, 32, this.height - 64, 36)).func_148195_a(this.savedServerList);
        }
        else {
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
                ...
                this.mc2.displayGuiScreen(new GuiScreenServerList(this, this.selectedServer = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "", false)));
            }
            else if (button.id == 3) {
                this.addingServer = true;
                this.mc2.displayGuiScreen(new GuiScreenAddServer(this, this.selectedServer = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "", false)));
            }
                ...
                this.mc2.displayGuiScreen(new GuiScreenAddServer(this, this.selectedServer));
            }
            else if (button.id == 0) {
    ...
    private void refreshServerList() {
        this.mc2.displayGuiScreen(new GuiMultiplayer(this.parentScreen));
    }
    ...
    private void connectToServer(final ServerData server) {
        this.mc2.displayGuiScreen(new GuiConnecting(this, this.mc2, server));
        ServerUtils.lastServer = server;
    }
