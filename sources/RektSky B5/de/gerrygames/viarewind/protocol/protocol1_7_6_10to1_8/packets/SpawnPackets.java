                ...
                this.handler(packetWrapper -> {
                    ...
                    if (gameProfile != null && gameProfile.gamemode == 3) {
                        ...
                        for (short i2 = 0; i2 < 4; i2 = (short)(i2 + 1)) {
                            ...
                            equipmentPacket.write(Type.INT, entityId);
                            equipmentPacket.write(Type.SHORT, i2);
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (typeId == 71) {
                        ...
                        armorStand.setLocation((double)x2 / 32.0, (double)y2 / 32.0, (double)z2 / 32.0);
                    ...
                    packetWrapper.set(Type.INT, 0, x2);
                    packetWrapper.set(Type.INT, 1, y2);
                    packetWrapper.set(Type.INT, 2, z2);
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (typeId == 30) {
                        ...
                        guardian.setLocation((double)x2 / 32.0, (double)y2 / 32.0, (double)z2 / 32.0);
                        ...
                        endermite.setLocation((double)x2 / 32.0, (double)y2 / 32.0, (double)z2 / 32.0);
