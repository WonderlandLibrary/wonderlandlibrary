...
public class GuiShaders extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, String.valueOf(this.screenTitle) + " ", (float)(this.width / 2), 15, 16777215);
        ...
        if (i < this.width - 5) {
            this.drawCenteredString(this.fontRendererObj, s, (float)(this.width / 2), this.height - 40, 8421504);
        }
        else {
    ...
    public void drawCenteredString(final String text, final int x, final int y, final int color) {
        this.drawCenteredString(this.fontRendererObj, text, (float)x, y, color);
    }
