...
extends EntityTrackerBase {
    ...
    public boolean interactedBlockRecently(int x2, int y2, int z2) {
        return this.blockInteractions.contains(new Position(x2, (short)y2, z2));
    }

    public void addBlockInteraction(Position p2) {
        this.blockInteractions.add(p2);
    }
