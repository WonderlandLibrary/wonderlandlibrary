...
public final class AuraMod extends Module {
   ...
   public AuraMod() {
      ...
      EntityCheck entityCheck = new EntityCheck(this.players, this.animals, this.monsters, this.invisibles, () -> ((FriendProtectMod)Autumn.MANAGER_REGISTRY.moduleManager.getModuleOrNull(FriendProtectMod.class)).isEnabled());
