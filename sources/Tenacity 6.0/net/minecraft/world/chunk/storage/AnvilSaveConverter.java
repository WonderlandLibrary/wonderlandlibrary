...
public class AnvilSaveConverter extends SaveFormatOld
{
    ...
    public AnvilSaveConverter(final File savesDirectoryIn) {
    ...
    private void convertChunks(final File p_75811_1_, final File p_75811_2_, final WorldChunkManager p_75811_3_, final int p_75811_4_, final int p_75811_5_, final IProgressUpdate progressCallback) {
        try {
            ...
            final RegionFile regionfile2 = new RegionFile(new File(p_75811_1_, s.substring(0, s.length() - ".mcr".length()) + ".mca"));
            for (int i = 0; i < 32; ++i) {
                for (int j = 0; j < 32; ++j) {
