...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        ...
        if (button.id == 1) {
            this.mc2.displayGuiScreen(this.createWorldGui);
        }
        else if (button.id == 0) {
            ...
            this.mc2.displayGuiScreen(new GuiFlatPresets(this));
        }
    ...
    class Details extends GuiSlot
    {
        ...
        public Details() {
            super(GuiCreateFlatWorld.this.mc2, GuiCreateFlatWorld.this.width, GuiCreateFlatWorld.this.height, 43, GuiCreateFlatWorld.this.height - 60, 24);
        ...
        private void func_148224_c(final int p_148224_1_, final int p_148224_2_, final int p_148224_3_, final int p_148224_4_) {
            ...
            final double x = p_148224_1_ + 0;
            final double y = p_148224_2_ + 18;
            final GuiCreateFlatWorld this$0 = GuiCreateFlatWorld.this;
            worldRenderer.pos(x, y, GuiCreateFlatWorld.zLevel).tex((p_148224_3_ + 0) * 0.0078125f, (p_148224_4_ + 18) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer2 = worldrenderer;
            final double x2 = p_148224_1_ + 18;
            final double y2 = p_148224_2_ + 18;
            final GuiCreateFlatWorld this$2 = GuiCreateFlatWorld.this;
            worldRenderer2.pos(x2, y2, GuiCreateFlatWorld.zLevel).tex((p_148224_3_ + 18) * 0.0078125f, (p_148224_4_ + 18) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer3 = worldrenderer;
            final double x3 = p_148224_1_ + 18;
            final double y3 = p_148224_2_ + 0;
            final GuiCreateFlatWorld this$3 = GuiCreateFlatWorld.this;
            worldRenderer3.pos(x3, y3, GuiCreateFlatWorld.zLevel).tex((p_148224_3_ + 18) * 0.0078125f, (p_148224_4_ + 0) * 0.0078125f).endVertex();
            final WorldRenderer worldRenderer4 = worldrenderer;
            final double x4 = p_148224_1_ + 0;
            final double y4 = p_148224_2_ + 0;
            final GuiCreateFlatWorld this$4 = GuiCreateFlatWorld.this;
            worldRenderer4.pos(x4, y4, GuiCreateFlatWorld.zLevel).tex((p_148224_3_ + 0) * 0.0078125f, (p_148224_4_ + 0) * 0.0078125f).endVertex();
            tessellator.draw();
        }
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            GuiCreateFlatWorld.this.fontRendererObj.drawString(s, (float)(p_180791_2_ + 18 + 5), (float)(p_180791_3_ + 3), 16777215);
            String s2;
            if (entryID == 0) {
            ...
            GuiCreateFlatWorld.this.fontRendererObj.drawString(s2, p_180791_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRendererObj.getStringWidth(s2), (float)(p_180791_3_ + 3), 16777215);
        }
