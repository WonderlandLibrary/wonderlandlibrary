...
public class GuiScreenOptionsSounds extends GuiScreen
{
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled && button.id == 200) {
            ...
            this.mc2.displayGuiScreen(this.field_146505_f);
        }
    }
    ...
    class Button extends GuiButton
    {
        ...
        public void mouseReleased(final int mouseX, final int mouseY) {
            if (this.field_146155_p) {
                ...
                GuiScreenOptionsSounds.this.mc2.getSoundHandler().playSound(PositionedSoundRecord.create(new ResourceLocation("gui.button.press"), 1.0f));
            }
