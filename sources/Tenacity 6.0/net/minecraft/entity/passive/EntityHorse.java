...
public class EntityHorse extends EntityAnimal implements IInvBasic
{
    ...
    private void setHorseTexturePaths() {
        ...
        if (i == 0) {
            ...
            this.texturePrefix += EntityHorse.HORSE_TEXTURES_ABBR[k];
            if (l >= EntityHorse.horseMarkingTextures.length) {
                this.field_175508_bO = false;
                return;
            }
            this.horseTexturesArray[1] = EntityHorse.horseMarkingTextures[l];
            this.texturePrefix += EntityHorse.HORSE_MARKING_TEXTURES_ABBR[l];
        }
        else {
        ...
        if (i2 >= EntityHorse.horseArmorTextures.length) {
            ...
            this.texturePrefix += EntityHorse.HORSE_ARMOR_TEXTURES_ABBR[i2];
