...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        switch (button.id) {
            case 0: {
                ...
                this.mc2.displayGuiScreen(this.field_175314_r);
                break;
            }
            case 1: {
                this.mc2.displayGuiScreen(this.field_175314_r);
    ...
    class ListPreset extends GuiSlot
    {
        ...
        public ListPreset() {
            super(GuiScreenCustomizePresets.this.mc2, GuiScreenCustomizePresets.this.width, GuiScreenCustomizePresets.this.height, 80, GuiScreenCustomizePresets.this.height - 32, 38);
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            GuiScreenCustomizePresets.this.fontRendererObj.drawString(guiscreencustomizepresets$info.field_178955_a, (float)(p_180791_2_ + 32 + 10), (float)(p_180791_3_ + 14), 16777215);
        }
    }
}
