...
implements DisplayImplementation {
    ...
    public void createWindow(DrawableLWJGL drawable, DisplayMode mode, Canvas parent, int x2, int y2) throws LWJGLException {
        ...
        try {
            this.window = this.nCreateWindow(x2, y2, mode.getWidth(), mode.getHeight(), fullscreen, MacOSXDisplay.isUndecorated(), resizable, parented, enableFullscreenModeAPI, this.enableHighDPI, peer_handle, window_handle);
            if (fullscreen) {
