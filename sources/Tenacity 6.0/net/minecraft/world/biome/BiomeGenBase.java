...
public abstract class BiomeGenBase
{
    ...
    protected BiomeGenBase func_150557_a(final int colorIn, final boolean p_150557_2_) {
        this.color = colorIn;
        if (p_150557_2_) {
                ...
                if (iblockstate3.getBlock().getMaterial() == Material.air) {
                    ...
                    if (j == -1) {
                        ...
                        if (j2 < i && (iblockstate == null || iblockstate.getBlock().getMaterial() == Material.air)) {
                            if (this.getFloatTemperature(blockpos$mutableblockpos.set(x, j2, z)) < 0.15f) {
    ...
    static {
        ...
        for (final BiomeGenBase biomegenbase : BiomeGenBase.biomeList) {
