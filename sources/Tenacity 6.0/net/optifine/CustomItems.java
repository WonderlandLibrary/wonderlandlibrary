...
public class CustomItems
{
    ...
    private static Map makePotionImageProperties(final IResourcePack rp, final String type, final int itemId) {
        ...
        for (int i = 0; i < astring3.length; ++i) {
            ...
            if (properties != null) {
                final String s3 = StrUtils.removeSuffix(s2, astring2) + ".properties";
    ...
    private static Properties makePotionProperties(final String name, final String type, int itemId, final String path) {
        ...
        properties2.put("items", "" + itemId);
        properties2.put("damage", "" + stringbuffer.toString());
        properties2.put("damageMask", "" + k);
        if (type.equals("splash")) {
    ...
    private static CustomItemProperties[][] propertyListToArray(final List list) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (list2 != null) {
                final CustomItemProperties[] acustomitemproperties2 = list2.toArray(new CustomItemProperties[list2.size()]);
