...
public class Shaders
{
    ...
    private static void saveOptionProperties(final IShaderPack sp, final Properties props) throws IOException {
        final String s = Shaders.shaderpacksdirname + "/" + sp.getName() + ".txt";
        ...
        if (!Shaders.isShaderPackInitialized) {
            ...
            for (int k1 = 0; k1 < 33; ++k1) {
                ...
                if (s2.equals("")) {
                    ...
                    final int j = setupProgram(k1, s4 + ".vsh", s4 + ".fsh");
                    if (j > 0) {
            ...
            try {
                for (final String s4 : list) {
                    ...
                    if (inputstream != null) {
                        ...
                        inputstream.close();
                        for (final Object s5 : ((Hashtable<Object, V>)properties).keySet()) {
