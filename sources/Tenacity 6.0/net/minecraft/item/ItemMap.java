                    ...
                    for (int l2 = i2 - j2 - 1; l2 < i2 + j2; ++l2) {
                        if (k2 >= 0 && l2 >= -1 && k2 < 128 && l2 < 128) {
                            ...
                            if (!chunk.isEmpty()) {
                                    ...
                                    for (int i5 = 0; i5 < i; ++i5) {
                                        for (int j5 = 0; j5 < i; ++j5) {
                                            ...
                                            if (k5 > 1) {
                                                do {
                                                    --k5;
                                                    iblockstate = chunk.getBlockState(blockpos$mutableblockpos.set(i5 + i4, k5, j5 + j4));
                                ...
                                final MapColor mapcolor = (MapColor)Iterables.getFirst((Iterable)Multisets.copyHighestCountFirst((Multiset)multiset), (Object)MapColor.airColor);
