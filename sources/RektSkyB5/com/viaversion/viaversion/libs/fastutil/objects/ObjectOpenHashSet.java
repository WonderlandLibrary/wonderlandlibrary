...
Hash {
    ...
    public ObjectOpenHashSet(Iterator<? extends K> i2, float f2) {
        this(16, f2);
        while (i2.hasNext()) {
            this.add(i2.next());
        }
    ...
    public ObjectOpenHashSet(Iterator<? extends K> i2) {
        this(i2, 0.75f);
    }
    ...
    public static <K> ObjectOpenHashSet<K> of(K e2) {
    ...
    @SafeVarargs
    public static <K> ObjectOpenHashSet<K> of(K ... a2) {
        ObjectOpenHashSet<K> result = new ObjectOpenHashSet<K>(a2.length, 0.75f);
        for (K element : a2) {
