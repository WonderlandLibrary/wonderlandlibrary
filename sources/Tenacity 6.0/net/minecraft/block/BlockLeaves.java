...
public abstract class BlockLeaves extends BlockLeavesBase
{
                ...
                for (int i3 = -i; i3 <= i; ++i3) {
                    for (int j3 = -i; j3 <= i; ++j3) {
                        for (int k3 = -i; k3 <= i; ++k3) {
                            final Block block = worldIn.getBlockState(blockpos$mutableblockpos.set(k + i3, l + j3, i2 + k3)).getBlock();
    ...
    public EnumWorldBlockLayer getBlockLayer() {
        return XRay.enabled ? EnumWorldBlockLayer.TRANSLUCENT : (this.isTransparent ? EnumWorldBlockLayer.CUTOUT_MIPPED : EnumWorldBlockLayer.SOLID);
    }
