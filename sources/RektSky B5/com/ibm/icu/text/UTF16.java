...
public final class UTF16 {
        ...
        block2: for (int r2 = offset; r2 < e2; ++r2) {
            ...
            while (true) {
                try {
                    ...
                    chars[w2] = (char)(55232 + (cp >> 10));
                    chars[w2 + 1] = (char)(56320 + (cp & 0x3FF));
                    w2 += 2;
                    continue block2;
                }
    ...
    public static int getSingleCodePoint(CharSequence s2) {
        ...
        int cp = Character.codePointAt(s2, 0);
        if (cp > 65535) {
            return cp;
        }
        return -1;
    ...
    public static int compareCodePoint(int codePoint, CharSequence s2) {
        if (s2 == null) {
            return 1;
        }
        ...
        int second = Character.codePointAt(s2, 0);
