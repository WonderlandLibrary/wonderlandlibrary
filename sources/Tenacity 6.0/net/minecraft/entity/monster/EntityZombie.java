        ...
        if (livingdata instanceof GroupData) {
            ...
            if (entityzombie$groupdata.isChild) {
                ...
                if (this.worldObj.rand.nextFloat() < 0.05) {
                    final List<EntityChicken> list = this.worldObj.getEntitiesWithinAABB((Class<? extends EntityChicken>)EntityChicken.class, this.getEntityBoundingBox().expand(5.0, 3.0, 5.0), (com.google.common.base.Predicate<? super EntityChicken>)EntitySelectors.IS_STANDALONE);
                    if (!list.isEmpty()) {
            ...
            for (int k = (int)this.posX - 4; k < (int)this.posX + 4 && j < 14; ++k) {
                for (int l = (int)this.posY - 4; l < (int)this.posY + 4 && j < 14; ++l) {
                    for (int i2 = (int)this.posZ - 4; i2 < (int)this.posZ + 4 && j < 14; ++i2) {
                        final Block block = this.worldObj.getBlockState(blockpos$mutableblockpos.set(k, l, i2)).getBlock();
