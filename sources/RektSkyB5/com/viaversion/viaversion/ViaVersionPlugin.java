...
implements ViaPlatform<Player> {
    ...
    public void onEnable() {
        ...
        for (Runnable r2 : this.queuedTasks) {
            Bukkit.getScheduler().runTask((Plugin)this, r2);
        }
        this.queuedTasks.clear();
        for (Runnable r2 : this.asyncQueuedTasks) {
            Bukkit.getScheduler().runTaskAsynchronously((Plugin)this, r2);
        }
    ...
    public ViaCommandSender[] getOnlinePlayers() {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            array[i2++] = new BukkitCommandSender((CommandSender)player);
        }
        return array;
    }
