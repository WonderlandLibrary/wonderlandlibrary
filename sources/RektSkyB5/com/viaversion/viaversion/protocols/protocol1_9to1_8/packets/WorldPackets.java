                ...
                this.handler(new PacketHandler(){
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        if (effect != null && effect.isBreaksound()) {
                            ...
                            int y2 = wrapper.passthrough(Type.INT);
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        block4: {
                            ...
                            block3: {
                                ...
                                chunk = wrapper.read(new Chunk1_8Type(clientWorld));
            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler(){
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        Position p2 = wrapper.get(Type.POSITION, 0);
                        int x2 = p2.x();
                        int y2 = p2.y();
                        int z2 = p2.z();
                        switch (face) {
                        ...
                        EntityTracker1_9 tracker = (EntityTracker1_9)wrapper.user().getEntityTracker(Protocol1_9To1_8.class);
                        tracker.addBlockInteraction(new Position(x2, y2, z2));
                    }
                });
                this.handler(new PacketHandler(){
