...
public class LayerCape implements LayerRenderer<AbstractClientPlayer>
{
    ...
    public LayerCape(final RenderPlayer playerRendererIn) {
        this.cape = new ResourceLocation("Tenacity/Capes/c1.png");
    ...
    public void doRenderLayer(final AbstractClientPlayer entitylivingbaseIn, final float p_177141_2_, final float p_177141_3_, final float partialTicks, final float p_177141_5_, final float p_177141_6_, final float p_177141_7_, final float scale) {
        if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && !this.renderClientCape(entitylivingbaseIn, partialTicks) && entitylivingbaseIn.getLocationCape() != null) {
            ...
            final float prevRenderYawOffset = MathHelper.wrapAngleTo180_float(entitylivingbaseIn.prevRenderYawOffset);
            final float f = prevRenderYawOffset + (MathHelper.wrapAngleTo180_float(entitylivingbaseIn.renderYawOffset) - prevRenderYawOffset) * partialTicks;
    ...
    private boolean renderClientCape(final AbstractClientPlayer entitylivingbaseIn, final float partialTicks) {
