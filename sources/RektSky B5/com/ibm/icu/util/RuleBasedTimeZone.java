            ...
            if (this.historicRules != null) {
                ...
                while (true) {
                    ...
                    for (i2 = 0; i2 < this.historicRules.size(); ++i2) {
                        ...
                        if (r2 == curRule || r2.getName().equals(curRule.getName()) && r2.getRawOffset() == curRule.getRawOffset() && r2.getDSTSavings() == curRule.getDSTSavings() || (tt = d2.getTime()) >= nextTransitionTime) continue;
                    ...
                    if (this.finalRules != null) {
                        for (i2 = 0; i2 < 2; ++i2) {
                            if (this.finalRules[i2] == curRule || (d2 = this.finalRules[i2].getNextStart(lastTransitionTime, curStdOffset, curDstSavings, false)) == null || (tt = d2.getTime()) >= nextTransitionTime) continue;
                            nextTransitionTime = tt;
