...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    protected void keyTyped(final char typedChar, final int keyCode) throws IOException {
        if (keyCode == this.mc2.gameSettings.keyBindInventory.getKeyCode()) {
    ...
    protected void drawTitle() {
        final int i = (this.width - this.field_146555_f) / 2;
        final int j = (this.height - this.field_146557_g) / 2;
        this.fontRendererObj.drawString(I18n.format("gui.achievements", new Object[0]), (float)(i + 15), (float)(j + 5), 4210752);
    }
    ...
    protected void drawAchievementScreen(final int p_146552_1_, final int p_146552_2_, final float p_146552_3_) {
        ...
        for (int l4 = 0; l4 * f - j3 < 155.0f; ++l4) {
            ...
            for (int i5 = 0; i5 * f2 - i3 < 224.0f; ++i5) {
                random.setSeed(this.mc2.getSession().getPlayerID().hashCode() + k2 + i5 + (l2 + l4) * 16);
        ...
        this.mc2.getTextureManager().bindTexture(GuiAchievements.ACHIEVEMENT_BACKGROUND);
        ...
        if (achievement2 != null) {
            ...
            if (this.statFileWriter.canUnlockAchievement(achievement2)) {
                final int j9 = (int)Math.max(this.fontRendererObj.getStringWidth(s), 120.0f);
                ...
                final int k9 = (int)Math.max(this.fontRendererObj.getStringWidth(s), 120.0f);
                ...
                final int l9 = (int)Math.max(this.fontRendererObj.getStringWidth(s), 120.0f);
