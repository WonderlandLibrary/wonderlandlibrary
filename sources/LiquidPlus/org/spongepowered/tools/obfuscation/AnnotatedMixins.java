...
IJavadocProvider {
    ...
    private boolean shouldRemap(AnnotatedMixin mixinClass, AnnotationHandle annotation2) {
        return annotation2.getBoolean("remap", mixinClass.remap());
    }
    ...
    @Override
    public void printMessage(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationMirror annotation2) {
        this.processingEnv.getMessager().printMessage(kind, msg, element, annotation2);
    }

    @Override
    public void printMessage(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationMirror annotation2, AnnotationValue value) {
        this.processingEnv.getMessager().printMessage(kind, msg, element, annotation2, value);
    }
