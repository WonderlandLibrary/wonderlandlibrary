...
public final class ZoneMeta {
    ...
    public static Set<String> getAvailableIDs(TimeZone.SystemTimeZoneType type, String region, Integer rawOffset) {
        ...
        for (String id : baseSet) {
            OlsonTimeZone z2;
            String r2;
            if (region != null && !region.equals(r2 = ZoneMeta.getRegion(id)) || rawOffset != null && ((z2 = ZoneMeta.getSystemTimeZone(id)) == null || !rawOffset.equals(((TimeZone)z2).getRawOffset()))) continue;
            result.add(id);
        }
        if (result.isEmpty()) {
    ...
    private static synchronized String[] getZoneIDs() {
        if (ZONEIDS == null) {
            try {
                UResourceBundle top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", ZONEINFORESNAME, ICUResourceBundle.ICU_DATA_CLASS_LOADER);
    ...
    private static String findCLDRCanonicalID(String tzid) {
        ...
        try {
            UResourceBundle keyTypeData = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", "keyTypeData", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
    ...
    public static String getCanonicalCountry(String tzid, Output<Boolean> isPrimary) {
        ...
        if (singleZone.booleanValue()) {
            ...
            try {
                UResourceBundle bundle = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", "metaZones");
    ...
    public static UResourceBundle openOlsonResource(UResourceBundle top, String id) {
        ...
        if (zoneIdx >= 0) {
            try {
                ...
                if (top == null) {
                    top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", ZONEINFORESNAME, ICUResourceBundle.ICU_DATA_CLASS_LOADER);
                }
    ...
    extends SoftCache<String, OlsonTimeZone, String> {
        ...
        protected OlsonTimeZone createInstance(String key, String data) {
            ...
            try {
                UResourceBundle top = UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt62b", ZoneMeta.ZONEINFORESNAME, ICUResourceBundle.ICU_DATA_CLASS_LOADER);
