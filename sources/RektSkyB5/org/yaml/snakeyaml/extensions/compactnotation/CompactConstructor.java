...
extends Constructor {
    ...
    protected Object createInstance(ScalarNode node, CompactData data) throws Exception {
        ...
        for (int i2 = 0; i2 < args.length; ++i2) {
            args[i2] = String.class;
        }
        java.lang.reflect.Constructor<?> c2 = clazz.getDeclaredConstructor(args);
        c2.setAccessible(true);
        return c2.newInstance(data.getArguments().toArray());
    }
