...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        if (this.mc2.theWorld != null) {
            final EnumDifficulty enumdifficulty = this.mc2.theWorld.getDifficulty();
            ...
            if (this.mc2.isSingleplayer() && !this.mc2.theWorld.getWorldInfo().isHardcoreModeEnabled()) {
                ...
                this.field_175356_r.func_175229_b(this.mc2.theWorld.getWorldInfo().isDifficultyLocked());
    ...
    public void confirmClicked(final boolean result, final int id) {
        ...
        if (id == 109 && result && this.mc2.theWorld != null) {
            this.mc2.theWorld.getWorldInfo().setDifficultyLocked(true);
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 108) {
                this.mc2.theWorld.getWorldInfo().setDifficulty(EnumDifficulty.getDifficultyEnum(this.mc2.theWorld.getDifficulty().getDifficultyId() + 1));
                this.field_175357_i.displayString = this.func_175355_a(this.mc2.theWorld.getDifficulty());
            }
            if (button.id == 109) {
                this.mc2.displayGuiScreen(new GuiYesNo(this, new ChatComponentTranslation("difficulty.lock.title", new Object[0]).getFormattedText(), new ChatComponentTranslation("difficulty.lock.question", new Object[] { new ChatComponentTranslation(this.mc2.theWorld.getWorldInfo().getDifficulty().getDifficultyResourceKey(), new Object[0]) }).getFormattedText(), 109));
            }
            if (button.id == 110) {
                this.mc2.gameSettings.saveOptions();
                this.mc2.displayGuiScreen(new GuiCustomizeSkin(this));
            }
            if (button.id == 8675309) {
                this.mc2.entityRenderer.activateNextShader();
            }
            if (button.id == 101) {
                this.mc2.gameSettings.saveOptions();
                this.mc2.displayGuiScreen(new GuiVideoSettings(this, this.game_settings_1));
            }
            if (button.id == 100) {
                this.mc2.gameSettings.saveOptions();
                this.mc2.displayGuiScreen(new GuiControls(this, this.game_settings_1));
            }
            if (button.id == 102) {
                this.mc2.gameSettings.saveOptions();
                this.mc2.displayGuiScreen(new GuiLanguage(this, this.game_settings_1, this.mc2.getLanguageManager()));
            }
            if (button.id == 103) {
                this.mc2.gameSettings.saveOptions();
                this.mc2.displayGuiScreen(new ScreenChatOptions(this, this.game_settings_1));
            }
            if (button.id == 104) {
                this.mc2.gameSettings.saveOptions();
                this.mc2.displayGuiScreen(new GuiSnooper(this, this.game_settings_1));
            }
            if (button.id == 200) {
                this.mc2.gameSettings.saveOptions();
                this.mc2.displayGuiScreen(this.field_146441_g);
            }
            if (button.id == 105) {
                this.mc2.gameSettings.saveOptions();
                this.mc2.displayGuiScreen(new GuiScreenResourcePacks(this));
            }
            if (button.id == 106) {
                this.mc2.gameSettings.saveOptions();
                this.mc2.displayGuiScreen(new GuiScreenOptionsSounds(this, this.game_settings_1));
            }
        }
    }
