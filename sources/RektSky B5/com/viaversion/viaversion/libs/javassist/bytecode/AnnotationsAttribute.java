...
extends AttributeInfo {
    ...
    extends Walker {
        ...
        void constValueMember(int tag, int index) throws Exception {
            ...
            switch (tag) {
                case 66: {
                    m2 = new ByteMemberValue(index, cp);
                    break;
                }
                case 67: {
                    m2 = new CharMemberValue(index, cp);
                    break;
                }
                case 68: {
                    m2 = new DoubleMemberValue(index, cp);
                    break;
                }
                case 70: {
                    m2 = new FloatMemberValue(index, cp);
                    break;
                }
                case 73: {
                    m2 = new IntegerMemberValue(index, cp);
                    break;
                }
                case 74: {
                    m2 = new LongMemberValue(index, cp);
                    break;
                }
                case 83: {
                    m2 = new ShortMemberValue(index, cp);
                    break;
                }
                case 90: {
                    m2 = new BooleanMemberValue(index, cp);
                    break;
                }
                case 115: {
                    m2 = new StringMemberValue(index, cp);
                    break;
                }
                default: {
