...
public class Matrix3d implements Serializable, Cloneable
{
    ...
    static double compute_rot(final double n, final double n2, final double[] array, final double[] array2, final int n3, final int n4) {
        double n5;
        double n6;
        double n7;
        if (n2 == 0.0) {
            ...
            double n8 = n;
            double n9 = n2;
            double n10 = max(Math.abs(n8), Math.abs(n9));
            if (n10 >= 4.9947976805055876E145) {
                ...
                while (n10 >= 4.9947976805055876E145) {
                    ...
                    n10 = max(Math.abs(n8), Math.abs(n9));
                }
    ...
    private static final boolean almostEqual(final double n, final double n2) {
        if (n == n2) {
            return true;
        }
