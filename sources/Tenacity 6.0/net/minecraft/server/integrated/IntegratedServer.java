...
public class IntegratedServer extends MinecraftServer
{
    ...
    public void initiateShutdown() {
        ...
        Futures.getUnchecked((Future)this.addScheduledTask(() -> {
            Lists.newArrayList((Iterable)this.getConfigurationManager().getPlayerList()).iterator();
            while (iterator.hasNext()) {
                entityplayermp = iterator.next();
                this.getConfigurationManager().playerLoggedOut(entityplayermp);
            }
            return;
        }));
