...
public final class ObjectSpliterators {
    ...
    public static <K> ObjectSpliterator<K> asObjectSpliterator(Spliterator<K> i2) {
        if (i2 instanceof ObjectSpliterator) {
            return (ObjectSpliterator)i2;
        }
        return new SpliteratorWrapper<K>(i2);
    }

    public static <K> ObjectSpliterator<K> asObjectSpliterator(Spliterator<K> i2, Comparator<? super K> comparatorOverride) {
        if (i2 instanceof ObjectSpliterator) {
        ...
        return new SpliteratorWrapperWithComparator<K>(i2, comparatorOverride);
    }
    ...
    @SafeVarargs
    public static <K> ObjectSpliterator<K> concat(ObjectSpliterator<? extends K> ... a2) {
        return ObjectSpliterators.concat(a2, 0, a2.length);
    }

    public static <K> ObjectSpliterator<K> concat(ObjectSpliterator<? extends K>[] a2, int offset, int length) {
        return new SpliteratorConcatenator<K>(a2, offset, length);
    }
    ...
    implements ObjectSpliterator<K> {
        ...
        public SpliteratorWrapper(Spliterator<K> i2) {
            this.i = i2;
        }
    ...
    extends SpliteratorWrapper<K> {
        ...
        public SpliteratorWrapperWithComparator(Spliterator<K> i2, Comparator<? super K> comparator) {
            super(i2);
            this.comparator = comparator;
        }
    ...
    implements ObjectSpliterator<K> {
        ...
        public SpliteratorConcatenator(ObjectSpliterator<? extends K>[] a2, int offset, int length) {
            this.a = a2;
            this.offset = offset;
            this.length = length;
    ...
    implements ObjectSpliterator<K> {
        ...
        public long skip(long n2) {
            ...
            if (this.iter instanceof ObjectBigListIterator) {
                long skipped2 = ((ObjectBigListIterator)this.iter).skip(n2);
                this.size -= skipped2;
                return skipped2;
            }
