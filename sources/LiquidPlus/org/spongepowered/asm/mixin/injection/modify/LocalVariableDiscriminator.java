...
public class LocalVariableDiscriminator {
    ...
    public static LocalVariableDiscriminator parse(AnnotationNode annotation2) {
        boolean argsOnly = Annotations.getValue(annotation2, "argsOnly", Boolean.FALSE);
        int ordinal = Annotations.getValue(annotation2, "ordinal", -1);
        int index = Annotations.getValue(annotation2, "index", -1);
        boolean print = Annotations.getValue(annotation2, "print", Boolean.FALSE);
        HashSet<String> names = new HashSet<String>();
        List namesList = Annotations.getValue(annotation2, "name", (List)null);
        if (namesList != null) {
