                ...
                if (!iter$iv.hasNext()) {
                    ...
                    while (true) {
                        ...
                        if (i$iv >= result$iv.length) {
                            ...
                            Intrinsics.checkExpressionValueIsNotNull(Arrays.copyOf(result$iv, newSize$iv), "Arrays.copyOf(result, newSize)");
                            continue;
                        }
                    ...
                    Intrinsics.checkExpressionValueIsNotNull(objectArray2, "Arrays.copyOf(result, size)");
                }
            }
        }
        return objectArray;
            ...
            if (size$iv == 0) {
                ...
                if (!iter$iv.hasNext()) {
                    ...
                    if (result == a) {
                        ...
                        Intrinsics.checkExpressionValueIsNotNull(objectArray3, "Arrays.copyOf(result, size)");
                    }
                }
            }
        }
    ...
    private static final Object[] toArrayImpl(Collection<?> collection, Function0<Object[]> empty, Function1<? super Integer, Object[]> alloc, Function2<? super Object[], ? super Integer, Object[]> trim) {
        ...
        while (true) {
            ...
            if (i >= result.length) {
                ...
                Intrinsics.checkExpressionValueIsNotNull(Arrays.copyOf(result, newSize), "Arrays.copyOf(result, newSize)");
                continue;
            }
