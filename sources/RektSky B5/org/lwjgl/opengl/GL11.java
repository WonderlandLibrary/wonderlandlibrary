...
public final class GL11 {
    ...
    public static void glGetMap(int target, int query, FloatBuffer v2) {
        ...
        GL11.nglGetMapfv(target, query, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glGetMap(int target, int query, DoubleBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 256);
        GL11.nglGetMapdv(target, query, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glGetMap(int target, int query, IntBuffer v2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(v2, 256);
        GL11.nglGetMapiv(target, query, MemoryUtil.getAddress(v2), function_pointer);
    }
    ...
    public static void glLoadMatrix(FloatBuffer m2) {
        ...
        GL11.nglLoadMatrixf(MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glLoadMatrix(DoubleBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        GL11.nglLoadMatrixd(MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMultMatrix(FloatBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        GL11.nglMultMatrixf(MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glMultMatrix(DoubleBuffer m2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(m2, 16);
        GL11.nglMultMatrixd(MemoryUtil.getAddress(m2), function_pointer);
    }
    ...
    public static void glRotated(double angle, double x2, double y2, double z2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glRotated;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL11.nglRotated(angle, x2, y2, z2, function_pointer);
    }
    ...
    public static void glReadPixels(int x2, int y2, int width, int height, int format, int type, ByteBuffer pixels) {
        ...
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkBuffer(pixels, GLChecks.calculateImageStorage(pixels, format, type, width, height, 1));
        GL11.nglReadPixels(x2, y2, width, height, format, type, MemoryUtil.getAddress(pixels), function_pointer);
    }
