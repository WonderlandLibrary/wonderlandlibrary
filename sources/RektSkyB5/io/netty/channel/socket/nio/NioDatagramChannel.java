...
implements DatagramChannel {
    ...
    protected Object filterOutboundMessage(Object msg) {
        ...
        if (msg instanceof DatagramPacket) {
            DatagramPacket p2 = (DatagramPacket)msg;
            ByteBuf content = (ByteBuf)p2.content();
            if (NioDatagramChannel.isSingleDirectBuffer(content)) {
                return p2;
            }
            return new DatagramPacket(this.newDirectBuffer(p2, content), (InetSocketAddress)p2.recipient());
        }
        ...
        if (msg instanceof AddressedEnvelope && (e2 = (AddressedEnvelope)msg).content() instanceof ByteBuf) {
            ...
            return new DefaultAddressedEnvelope(this.newDirectBuffer(e2, content), e2.recipient());
        }
