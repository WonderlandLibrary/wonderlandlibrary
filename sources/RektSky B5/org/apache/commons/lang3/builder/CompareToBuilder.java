...
implements Builder<Integer> {
    ...
    private static void reflectionAppend(Object lhs, Object rhs, Class<?> clazz, CompareToBuilder builder, boolean useTransients, String[] excludeFields) {
        ...
        for (int i2 = 0; i2 < fields.length && builder.comparison == 0; ++i2) {
            AccessibleObject f2 = fields[i2];
            if (ArrayUtils.contains(excludeFields, ((Field)f2).getName()) || ((Field)f2).getName().contains("$") || !useTransients && Modifier.isTransient(((Field)f2).getModifiers()) || Modifier.isStatic(((Field)f2).getModifiers())) continue;
            try {
                builder.append(((Field)f2).get(lhs), ((Field)f2).get(rhs));
                continue;
            }
    ...
    public CompareToBuilder append(Object[] lhs, Object[] rhs, Comparator<?> comparator) {
        ...
        for (int i2 = 0; i2 < lhs.length && this.comparison == 0; ++i2) {
            this.append(lhs[i2], rhs[i2], comparator);
        }
        return this;
    }
