...
public class Quat4d extends Tuple4d implements Serializable
{
    ...
    public final void normalize(final Quat4d quat4d) {
        final double n = quat4d.x * quat4d.x + quat4d.y * quat4d.y + quat4d.z * quat4d.z + quat4d.w * quat4d.w;
        if (n > 0.0) {
    ...
    public final void normalize() {
        final double n = this.x * this.x + this.y * this.y + this.z * this.z + this.w * this.w;
        if (n > 0.0) {
            final double n2 = 1.0 / Math.sqrt(n);
            this.x *= n2;
            this.y *= n2;
    ...
    public final void set(final Matrix4f matrix4f) {
        final double n = 0.25 * (matrix4f.m00 + matrix4f.m11 + matrix4f.m22 + matrix4f.m33);
        if (n < 0.0) {
            this.w = 0.0;
            this.x = 0.0;
            this.y = 0.0;
        ...
        this.w = 0.0;
        final double n3 = -0.5 * (matrix4f.m11 + matrix4f.m22);
        if (n3 < 0.0) {
            this.x = 0.0;
            this.y = 0.0;
            this.z = 1.0;
        ...
        if (n3 >= 1.0E-30) {
            this.x = Math.sqrt(n3);
            final double n4 = 1.0 / (2.0 * this.x);
            this.y = matrix4f.m10 * n4;
            this.z = matrix4f.m20 * n4;
            return;
        }
        this.x = 0.0;
        final double n5 = 0.5 * (1.0 - matrix4f.m22);
        if (n5 >= 1.0E-30) {
            this.y = Math.sqrt(n5);
    ...
    public final void set(final Matrix4d matrix4d) {
        final double n = 0.25 * (matrix4d.m00 + matrix4d.m11 + matrix4d.m22 + matrix4d.m33);
        if (n < 0.0) {
            this.w = 0.0;
            this.x = 0.0;
            this.y = 0.0;
        ...
        if (n >= 1.0E-30) {
            this.w = Math.sqrt(n);
            final double n2 = 0.25 / this.w;
            this.x = (matrix4d.m21 - matrix4d.m12) * n2;
            this.y = (matrix4d.m02 - matrix4d.m20) * n2;
            this.z = (matrix4d.m10 - matrix4d.m01) * n2;
            return;
        }
        this.w = 0.0;
        final double n3 = -0.5 * (matrix4d.m11 + matrix4d.m22);
        if (n3 < 0.0) {
            this.x = 0.0;
            this.y = 0.0;
            this.z = 1.0;
        ...
        if (n3 >= 1.0E-30) {
            this.x = Math.sqrt(n3);
            final double n4 = 0.5 / this.x;
            this.y = matrix4d.m10 * n4;
            this.z = matrix4d.m20 * n4;
            return;
        }
        this.x = 0.0;
        final double n5 = 0.5 * (1.0 - matrix4d.m22);
        if (n5 >= 1.0E-30) {
            this.y = Math.sqrt(n5);
    ...
    public final void set(final Matrix3f matrix3f) {
        final double n = 0.25 * (matrix3f.m00 + matrix3f.m11 + matrix3f.m22 + 1.0);
        if (n < 0.0) {
            this.w = 0.0;
            this.x = 0.0;
            this.y = 0.0;
        ...
        this.w = 0.0;
        final double n3 = -0.5 * (matrix3f.m11 + matrix3f.m22);
        if (n3 < 0.0) {
            this.x = 0.0;
            this.y = 0.0;
            this.z = 1.0;
        ...
        this.x = 0.0;
        final double n5 = 0.5 * (1.0 - matrix3f.m22);
        if (n5 >= 1.0E-30) {
            this.y = Math.sqrt(n5);
    ...
    public final void set(final Matrix3d matrix3d) {
        final double n = 0.25 * (matrix3d.m00 + matrix3d.m11 + matrix3d.m22 + 1.0);
        if (n < 0.0) {
            this.w = 0.0;
            this.x = 0.0;
            this.y = 0.0;
        ...
        if (n >= 1.0E-30) {
            this.w = Math.sqrt(n);
            final double n2 = 0.25 / this.w;
            this.x = (matrix3d.m21 - matrix3d.m12) * n2;
            this.y = (matrix3d.m02 - matrix3d.m20) * n2;
            this.z = (matrix3d.m10 - matrix3d.m01) * n2;
            return;
        }
        this.w = 0.0;
        final double n3 = -0.5 * (matrix3d.m11 + matrix3d.m22);
        if (n3 < 0.0) {
            this.x = 0.0;
            this.y = 0.0;
            this.z = 1.0;
        ...
        if (n3 >= 1.0E-30) {
            this.x = Math.sqrt(n3);
            final double n4 = 0.5 / this.x;
            this.y = matrix3d.m10 * n4;
            this.z = matrix3d.m20 * n4;
            return;
        }
        this.x = 0.0;
        final double n5 = 0.5 * (1.0 - matrix3d.m22);
        if (n5 >= 1.0E-30) {
            this.y = Math.sqrt(n5);
    ...
    public final void interpolate(final Quat4d quat4d, final double n) {
        double n2 = this.x * quat4d.x + this.y * quat4d.y + this.z * quat4d.z + this.w * quat4d.w;
        if (n2 < 0.0) {
            quat4d.x = -quat4d.x;
            quat4d.y = -quat4d.y;
            quat4d.z = -quat4d.z;
        ...
        this.w = n3 * this.w + n4 * quat4d.w;
        this.x = n3 * this.x + n4 * quat4d.x;
        this.y = n3 * this.y + n4 * quat4d.y;
        this.z = n3 * this.z + n4 * quat4d.z;
    }
    
    public final void interpolate(final Quat4d quat4d, final Quat4d quat4d2, final double n) {
        double n2 = quat4d2.x * quat4d.x + quat4d2.y * quat4d.y + quat4d2.z * quat4d.z + quat4d2.w * quat4d.w;
        if (n2 < 0.0) {
            quat4d.x = -quat4d.x;
            quat4d.y = -quat4d.y;
            quat4d.z = -quat4d.z;
        ...
        this.w = n3 * quat4d.w + n4 * quat4d2.w;
        this.x = n3 * quat4d.x + n4 * quat4d2.x;
        this.y = n3 * quat4d.y + n4 * quat4d2.y;
        this.z = n3 * quat4d.z + n4 * quat4d2.z;
    }
}
