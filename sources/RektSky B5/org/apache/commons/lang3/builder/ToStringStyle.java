...
implements Serializable {
    ...
    static boolean isRegistered(Object value) {
        Map<Object, Object> m2 = ToStringStyle.getRegistry();
        return m2 != null && m2.containsKey(value);
    }
    ...
    static void unregister(Object value) {
        ...
        if (value != null && (m2 = ToStringStyle.getRegistry()) != null) {
            m2.remove(value);
            if (m2.isEmpty()) {
                REGISTRY.remove();
            }
    ...
    protected void removeLastFieldSeparator(StringBuffer buffer) {
        ...
        if (len > 0 && sepLen > 0 && len >= sepLen) {
            boolean match = true;
            for (int i2 = 0; i2 < sepLen; ++i2) {
                if (buffer.charAt(len - 1 - i2) == this.fieldSeparator.charAt(sepLen - 1 - i2)) continue;
                match = false;
                break;
            }
            if (match) {
    ...
    protected void appendDetail(StringBuffer buffer, String fieldName, long[] array) {
        ...
        for (int i2 = 0; i2 < array.length; ++i2) {
            ...
            this.appendDetail(buffer, fieldName, array[i2]);
        }
        buffer.append(this.arrayEnd);
    }
