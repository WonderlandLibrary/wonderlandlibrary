...
public class Block
{
    ...
    public boolean shouldSideBeRendered(final IBlockAccess worldIn, final BlockPos pos, final EnumFacing side) {
        ...
        if (XRay.enabled && XRay.isWhitelisted(BlockUtils.getBlockAtPos(pos))) {
            ...
            for (final EnumFacing si : EnumFacing.VALUES) {
                if (XRay.isExposed(worldIn, pos.offset(si), si, this.minY, this.maxY, this.minZ, this.maxZ, this.minX, this.maxX)) {
                    return true;
                }
            }
        }
    ...
    public void addCollisionBoxesToList(final World worldIn, final BlockPos pos, final IBlockState state, final AxisAlignedBB mask, final List<AxisAlignedBB> list, final Entity collidingEntity) {
        ...
        if (collidingEntity == Minecraft.getMinecraft().thePlayer) {
            final BoundingBoxEvent boundingBoxEvent = new BoundingBoxEvent(this, pos, axisalignedbb);
            Tenacity.INSTANCE.getEventProtocol().handleEvent(boundingBoxEvent);
    ...
    public EnumWorldBlockLayer getBlockLayer() {
        return XRay.enabled ? (XRay.isWhitelisted(this.blockState.getBlock()) ? EnumWorldBlockLayer.SOLID : EnumWorldBlockLayer.TRANSLUCENT) : EnumWorldBlockLayer.SOLID;
    }
    ...
    public float getAmbientOcclusionLightValue() {
        return XRay.enabled ? 1.0f : (this.isBlockNormalCube() ? 0.2f : 1.0f);
    }
    ...
    public static void registerBlocks() {
        ...
        registerBlock(85, "fence", new BlockFence(Material.wood, BlockPlanks.EnumType.OAK.getMapColor()).setHardness(2.0f).setResistance(5.0f).setStepSound(Block.soundTypeWood).setUnlocalizedName("fence"));
        ...
        registerBlock(188, "spruce_fence", new BlockFence(Material.wood, BlockPlanks.EnumType.SPRUCE.getMapColor()).setHardness(2.0f).setResistance(5.0f).setStepSound(Block.soundTypeWood).setUnlocalizedName("spruceFence"));
        registerBlock(189, "birch_fence", new BlockFence(Material.wood, BlockPlanks.EnumType.BIRCH.getMapColor()).setHardness(2.0f).setResistance(5.0f).setStepSound(Block.soundTypeWood).setUnlocalizedName("birchFence"));
        registerBlock(190, "jungle_fence", new BlockFence(Material.wood, BlockPlanks.EnumType.JUNGLE.getMapColor()).setHardness(2.0f).setResistance(5.0f).setStepSound(Block.soundTypeWood).setUnlocalizedName("jungleFence"));
        registerBlock(191, "dark_oak_fence", new BlockFence(Material.wood, BlockPlanks.EnumType.DARK_OAK.getMapColor()).setHardness(2.0f).setResistance(5.0f).setStepSound(Block.soundTypeWood).setUnlocalizedName("darkOakFence"));
        registerBlock(192, "acacia_fence", new BlockFence(Material.wood, BlockPlanks.EnumType.ACACIA.getMapColor()).setHardness(2.0f).setResistance(5.0f).setStepSound(Block.soundTypeWood).setUnlocalizedName("acaciaFence"));
