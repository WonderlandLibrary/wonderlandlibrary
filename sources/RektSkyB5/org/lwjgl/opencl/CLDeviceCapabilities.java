...
public class CLDeviceCapabilities {
    ...
    public CLDeviceCapabilities(CLDevice device) {
        ...
        try {
            ...
            throw new RuntimeException("The major and/or minor OpenCL version \"" + version + "\" is malformed: " + e2.getMessage());
        }
        Set<String> extensions = APIUtil.getExtensions(extensionList);
        this.CL_AMD_bus_addressable_memory = extensions.contains("cl_amd_bus_addressable_memory");
    ...
    public String toString() {
        ...
        if (this.CL_AMD_bus_addressable_memory) {
            buf.append("cl_amd_bus_addressable_memory ");
        }
