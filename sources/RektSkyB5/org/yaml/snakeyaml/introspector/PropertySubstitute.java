...
extends Property {
            ...
            if (!this.filler) {
                ...
                if (value instanceof Collection) {
                    ...
                    for (int i2 = 0; i2 < len; ++i2) {
                        this.write.invoke(object, Array.get(value, i2));
                    }
                }
            }
    ...
    public Object get(Object object) {
        try {
            ...
            throw new YAMLException("Unable to find getter for property '" + this.getName() + "' on object " + object + ":" + e2);
        }
    ...
    public void setTargetType(Class<?> targetType) {
        if (this.targetType != targetType) {
            ...
            block0: for (Class<?> c2 = targetType; c2 != null; c2 = c2.getSuperclass()) {
    ...
    private Method discoverMethod(Class<?> type, String name, Class<?> ... params) {
        for (Class<?> c2 = type; c2 != null; c2 = c2.getSuperclass()) {
            for (Method method : c2.getDeclaredMethods()) {
                ...
                for (int i2 = 0; i2 < parameterTypes.length; ++i2) {
                    if (parameterTypes[i2].isAssignableFrom(params[i2])) continue;
                    found = false;
                }
                if (!found) continue;
