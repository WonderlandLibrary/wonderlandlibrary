...
implements ChannelGroupFuture {
        ...
        public void operationComplete(ChannelFuture future) throws Exception {
            ...
            if (callSetDone) {
                if (DefaultChannelGroupFuture.this.failureCount > 0) {
                    ...
                    for (ChannelFuture f2 : DefaultChannelGroupFuture.this.futures.values()) {
                        if (f2.isSuccess()) continue;
                        failed.add(new DefaultEntry<Channel, Throwable>(f2.channel(), f2.cause()));
                    }
    ...
    protected void checkDeadLock() {
        ...
        if (e2 != null && e2 != ImmediateEventExecutor.INSTANCE && e2.inEventLoop()) {
