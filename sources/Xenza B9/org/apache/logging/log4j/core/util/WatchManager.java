...
public class WatchManager extends AbstractLifeCycle
{
    ...
    public WatchManager(final ConfigurationScheduler scheduler) {
        ...
        this.eventServiceList = ServiceLoaderUtil.loadServices(WatchEventService.class, MethodHandles.lookup(), true).collect((Collector<? super WatchEventService, ?, List<WatchEventService>>)Collectors.toList());
    }
