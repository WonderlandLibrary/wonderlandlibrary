...
implements SctpServerChannel {
    ...
    protected SocketAddress localAddress0() {
        try {
            Iterator<SocketAddress> i2 = this.sch.getAllLocalAddresses().iterator();
            if (i2.hasNext()) {
                return i2.next();
            }
        }
    ...
    protected int doReadMessages(List<Object> buf) throws Exception {
        ...
        block7: {
            ...
            AbstractInterruptibleChannel s2 = null;
            acceptedChannels = 0;
            try {
                ...
                if (selectedKeys > 0) {
                    ...
                    do {
                        ...
                        if (!key.isAcceptable() || (s2 = this.sch.accept()) == null) continue;
                        buf.add(new OioSctpChannel(this, (SctpChannel)s2));
                        ++acceptedChannels;
                ...
                logger.warn("Failed to create a new channel from an accepted sctp channel.", t2);
                if (s2 == null) break block7;
                try {
                    s2.close();
                }
                catch (Throwable t22) {
                    logger.warn("Failed to close a sctp channel.", t22);
                }
            }
        }
        return acceptedChannels;
