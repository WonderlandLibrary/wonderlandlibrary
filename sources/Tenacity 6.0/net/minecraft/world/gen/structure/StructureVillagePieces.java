...
public class StructureVillagePieces
{
    ...
    private static int func_75079_a(final List<PieceWeight> p_75079_0_) {
        boolean flag = false;
        int i = 0;
    ...
    private static Village func_176065_a(final Start start, final PieceWeight weight, final List<StructureComponent> p_176065_2_, final Random rand, final int p_176065_4_, final int p_176065_5_, final int p_176065_6_, final EnumFacing facing, final int p_176065_8_) {
    ...
    private static Village func_176067_c(final Start start, final List<StructureComponent> p_176067_1_, final Random rand, final int p_176067_3_, final int p_176067_4_, final int p_176067_5_, final EnumFacing facing, final int p_176067_7_) {
        final int i = func_75079_a(start.structureVillageWeightedPieceList);
        if (i <= 0) {
            return null;
        }
        int j = 0;
        while (j < 5) {
            ...
            for (final PieceWeight structurevillagepieces$pieceweight : start.structureVillageWeightedPieceList) {
                ...
                if (k < 0) {
                    ...
                    final Village structurevillagepieces$village = func_176065_a(start, structurevillagepieces$pieceweight, p_176067_1_, rand, p_176067_3_, p_176067_4_, p_176067_5_, facing, p_176067_7_);
        ...
        final StructureBoundingBox structureboundingbox = Torch.func_175856_a(start, p_176067_1_, rand, p_176067_3_, p_176067_4_, p_176067_5_, facing);
    ...
    private static StructureComponent func_176066_d(final Start start, final List<StructureComponent> p_176066_1_, final Random rand, final int p_176066_3_, final int p_176066_4_, final int p_176066_5_, final EnumFacing facing, final int p_176066_7_) {
        if (p_176066_7_ > 50) {
            return null;
        }
        if (Math.abs(p_176066_3_ - start.getBoundingBox().minX) <= 112 && Math.abs(p_176066_5_ - start.getBoundingBox().minZ) <= 112) {
            final StructureComponent structurecomponent = func_176067_c(start, p_176066_1_, rand, p_176066_3_, p_176066_4_, p_176066_5_, facing, p_176066_7_ + 1);
            if (structurecomponent != null) {
                final int i = (structurecomponent.boundingBox.minX + structurecomponent.boundingBox.maxX) / 2;
                final int j = (structurecomponent.boundingBox.minZ + structurecomponent.boundingBox.maxZ) / 2;
                final int k = structurecomponent.boundingBox.maxX - structurecomponent.boundingBox.minX;
                final int l = structurecomponent.boundingBox.maxZ - structurecomponent.boundingBox.minZ;
                final int i2 = (k > l) ? k : l;
                if (start.getWorldChunkManager().areBiomesViable(i, j, i2 / 2 + 4, MapGenVillage.villageSpawnBiomes)) {
    ...
    private static StructureComponent func_176069_e(final Start start, final List<StructureComponent> p_176069_1_, final Random rand, final int p_176069_3_, final int p_176069_4_, final int p_176069_5_, final EnumFacing facing, final int p_176069_7_) {
        ...
        if (Math.abs(p_176069_3_ - start.getBoundingBox().minX) <= 112 && Math.abs(p_176069_5_ - start.getBoundingBox().minZ) <= 112) {
            final StructureBoundingBox structureboundingbox = Path.func_175848_a(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);
    ...
    public static class Church extends Village
    {
        ...
        public Church(final Start start, final int p_i45564_2_, final Random rand, final StructureBoundingBox p_i45564_4_, final EnumFacing facing) {
            super(start, p_i45564_2_);
            this.coordBaseMode = facing;
            this.boundingBox = p_i45564_4_;
        }
        
        public static Church func_175854_a(final Start start, final List<StructureComponent> p_175854_1_, final Random rand, final int p_175854_3_, final int p_175854_4_, final int p_175854_5_, final EnumFacing facing, final int p_175854_7_) {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode.getOpposite()), 2, 4, 7, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode.rotateY()), 1, 4, 6, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode.rotateYCCW()), 3, 4, 6, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode), 2, 4, 5, structureBoundingBoxIn);
    ...
    public static class Field1 extends Village
    {
        ...
        public Field1(final Start start, final int p_i45570_2_, final Random rand, final StructureBoundingBox p_i45570_4_, final EnumFacing facing) {
        ...
        private Block func_151559_a(final Random rand) {
        ...
        public static Field1 func_175851_a(final Start start, final List<StructureComponent> p_175851_1_, final Random rand, final int p_175851_3_, final int p_175851_4_, final int p_175851_5_, final EnumFacing facing, final int p_175851_7_) {
    ...
    public static class Field2 extends Village
    {
        ...
        private Block func_151560_a(final Random rand) {
            switch (rand.nextInt(5)) {
                case 0: {
                    return Blocks.carrots;
                }
        ...
        public static Field2 func_175852_a(final Start start, final List<StructureComponent> p_175852_1_, final Random rand, final int p_175852_3_, final int p_175852_4_, final int p_175852_5_, final EnumFacing facing, final int p_175852_7_) {
    ...
    public static class Hall extends Village
    {
        ...
        public Hall(final Start start, final int p_i45567_2_, final Random rand, final StructureBoundingBox p_i45567_4_, final EnumFacing facing) {
            super(start, p_i45567_2_);
            this.coordBaseMode = facing;
            this.boundingBox = p_i45567_4_;
        }
        
        public static Hall func_175857_a(final Start start, final List<StructureComponent> p_175857_1_, final Random rand, final int p_175857_3_, final int p_175857_4_, final int p_175857_5_, final EnumFacing facing, final int p_175857_7_) {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            this.setBlockState(worldIn, Blocks.air.getDefaultState(), 2, 1, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.air.getDefaultState(), 2, 2, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode), 2, 3, 1, structureBoundingBoxIn);
            this.placeDoorCurrentPosition(worldIn, structureBoundingBoxIn, randomIn, 2, 1, 0, EnumFacing.getHorizontal(this.getMetadataWithOffset(Blocks.oak_door, 1)));
            if (this.getBlockStateFromPos(worldIn, 2, 0, -1, structureBoundingBoxIn).getBlock().getMaterial() == Material.air && this.getBlockStateFromPos(worldIn, 2, -1, -1, structureBoundingBoxIn).getBlock().getMaterial() != Material.air) {
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(this.getMetadataWithOffset(Blocks.stone_stairs, 3)), 2, 0, -1, structureBoundingBoxIn);
            }
            ...
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode.getOpposite()), 6, 3, 4, structureBoundingBoxIn);
            ...
            for (int i2 = 0; i2 < 5; ++i2) {
                for (int j2 = 0; j2 < 9; ++j2) {
                    this.clearCurrentPositionBlocksUpwards(worldIn, j2, 7, i2, structureBoundingBoxIn);
    ...
    public static class House1 extends Village
    {
        ...
        public House1(final Start start, final int p_i45571_2_, final Random rand, final StructureBoundingBox p_i45571_4_, final EnumFacing facing) {
            super(start, p_i45571_2_);
            this.coordBaseMode = facing;
            this.boundingBox = p_i45571_4_;
        }
        
        public static House1 func_175850_a(final Start start, final List<StructureComponent> p_175850_1_, final Random rand, final int p_175850_3_, final int p_175850_4_, final int p_175850_5_, final EnumFacing facing, final int p_175850_7_) {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            final int j2 = this.getMetadataWithOffset(Blocks.oak_stairs, 3);
            this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(j2), 6, 1, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(j2), 5, 1, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(j2), 4, 1, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(j2), 3, 1, 4, structureBoundingBoxIn);
            ...
            for (int k2 = 0; k2 < 6; ++k2) {
                for (int i2 = 0; i2 < 9; ++i2) {
                    this.clearCurrentPositionBlocksUpwards(worldIn, i2, 9, k2, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.cobblestone.getDefaultState(), i2, -1, k2, structureBoundingBoxIn);
                }
            }
            this.spawnVillagers(worldIn, structureBoundingBoxIn, 2, 1, 2, 1);
            return true;
    ...
    public static class House2 extends Village
    {
        ...
        public House2(final Start start, final int p_i45563_2_, final Random rand, final StructureBoundingBox p_i45563_4_, final EnumFacing facing) {
            super(start, p_i45563_2_);
            this.coordBaseMode = facing;
            this.boundingBox = p_i45563_4_;
        }
        
        public static House2 func_175855_a(final Start start, final List<StructureComponent> p_175855_1_, final Random rand, final int p_175855_3_, final int p_175855_4_, final int p_175855_5_, final EnumFacing facing, final int p_175855_7_) {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (!this.hasMadeChest && structureBoundingBoxIn.isVecInside(new BlockPos(this.getXWithOffset(5, 5), this.getYWithOffset(1), this.getZWithOffset(5, 5)))) {
                ...
                this.generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 5, 1, 5, House2.villageBlacksmithChestContents, 3 + randomIn.nextInt(6));
            }
            for (int i = 6; i <= 8; ++i) {
    ...
    public static class House3 extends Village
    {
        ...
        public House3(final Start start, final int p_i45561_2_, final Random rand, final StructureBoundingBox p_i45561_4_, final EnumFacing facing) {
            super(start, p_i45561_2_);
            this.coordBaseMode = facing;
            this.boundingBox = p_i45561_4_;
        }
        
        public static House3 func_175849_a(final Start start, final List<StructureComponent> p_175849_1_, final Random rand, final int p_175849_3_, final int p_175849_4_, final int p_175849_5_, final EnumFacing facing, final int p_175849_7_) {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            final int k2 = this.getMetadataWithOffset(Blocks.oak_stairs, 0);
            for (int l2 = 4; l2 >= 1; --l2) {
                this.setBlockState(worldIn, Blocks.planks.getDefaultState(), l2, 2 + l2, 7 - l2, structureBoundingBoxIn);
                for (int i2 = 8 - l2; i2 <= 10; ++i2) {
                    this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(k2), l2, 2 + l2, i2, structureBoundingBoxIn);
                }
            }
            final int i3 = this.getMetadataWithOffset(Blocks.oak_stairs, 1);
            ...
            this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(i3), 6, 6, 4, structureBoundingBoxIn);
            for (int j2 = 6; j2 <= 8; ++j2) {
                for (int j3 = 5; j3 <= 10; ++j3) {
                    this.setBlockState(worldIn, Blocks.oak_stairs.getStateFromMeta(i3), j2, 12 - j2, j3, structureBoundingBoxIn);
                }
            }
            this.setBlockState(worldIn, Blocks.log.getDefaultState(), 0, 2, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.log.getDefaultState(), 0, 2, 4, structureBoundingBoxIn);
            ...
            for (int k3 = 0; k3 < 5; ++k3) {
                for (int i4 = 0; i4 < 9; ++i4) {
                    this.clearCurrentPositionBlocksUpwards(worldIn, i4, 7, k3, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.cobblestone.getDefaultState(), i4, -1, k3, structureBoundingBoxIn);
                }
            }
            for (int l3 = 5; l3 < 11; ++l3) {
                for (int j4 = 2; j4 < 9; ++j4) {
                    this.clearCurrentPositionBlocksUpwards(worldIn, j4, 7, l3, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.cobblestone.getDefaultState(), j4, -1, l3, structureBoundingBoxIn);
                }
            }
            this.spawnVillagers(worldIn, structureBoundingBoxIn, 4, 1, 2, 2);
            return true;
    ...
    public static class House4Garden extends Village
    {
        ...
        public static House4Garden func_175858_a(final Start start, final List<StructureComponent> p_175858_1_, final Random rand, final int p_175858_3_, final int p_175858_4_, final int p_175858_5_, final EnumFacing facing, final int p_175858_7_) {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (this.isRoofAccessible) {
                final int i = this.getMetadataWithOffset(Blocks.ladder, 3);
    ...
    public static class Path extends Road
    {
        ...
        public void buildComponent(final StructureComponent componentIn, final List<StructureComponent> listIn, final Random rand) {
            ...
            if (flag && rand.nextInt(3) > 0 && this.coordBaseMode != null) {
                switch (this.coordBaseMode) {
                    case NORTH: {
                        func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                        break;
                    }
                    case SOUTH: {
                        func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                        break;
                    }
                    case WEST: {
                        func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        break;
                    }
                    case EAST: {
                        func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        break;
                    }
                }
            }
            if (flag && rand.nextInt(3) > 0 && this.coordBaseMode != null) {
                switch (this.coordBaseMode) {
                    case NORTH: {
                        func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                        break;
                    }
                    case SOUTH: {
                        func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                        break;
                    }
                    case WEST: {
                        func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        break;
                    }
                    case EAST: {
                        func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        break;
                    }
                }
            }
        ...
        public static StructureBoundingBox func_175848_a(final Start start, final List<StructureComponent> p_175848_1_, final Random rand, final int p_175848_3_, final int p_175848_4_, final int p_175848_5_, final EnumFacing facing) {
        ...
        @Override
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            final IBlockState iblockstate = this.func_175847_a(Blocks.gravel.getDefaultState());
            final IBlockState iblockstate2 = this.func_175847_a(Blocks.cobblestone.getDefaultState());
            for (int i = this.boundingBox.minX; i <= this.boundingBox.maxX; ++i) {
                for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j) {
                    ...
                    if (structureBoundingBoxIn.isVecInside(blockpos)) {
                        ...
                        worldIn.setBlockState(blockpos.down(), iblockstate2, 2);
                    }
                }
            }
            return true;
    ...
    public static class Start extends Well
    {
        ...
        public Start(final WorldChunkManager chunkManagerIn, final int p_i2104_2_, final Random rand, final int p_i2104_4_, final int p_i2104_5_, final List<PieceWeight> p_i2104_6_, final int p_i2104_7_) {
            ...
            final BiomeGenBase biomegenbase = chunkManagerIn.getBiomeGenerator(new BlockPos(p_i2104_4_, 0, p_i2104_5_), BiomeGenBase.field_180279_ad);
            this.func_175846_a(this.inDesert = (biomegenbase == BiomeGenBase.desert || biomegenbase == BiomeGenBase.desertHills));
        }
    ...
    public static class Torch extends Village
    {
        ...
        public static StructureBoundingBox func_175856_a(final Start start, final List<StructureComponent> p_175856_1_, final Random rand, final int p_175856_3_, final int p_175856_4_, final int p_175856_5_, final EnumFacing facing) {
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            final boolean flag = this.coordBaseMode == EnumFacing.EAST || this.coordBaseMode == EnumFacing.NORTH;
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode.rotateY()), flag ? 2 : 0, 3, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode), 1, 3, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode.rotateYCCW()), flag ? 0 : 2, 3, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty<Comparable>)BlockTorch.FACING, this.coordBaseMode.getOpposite()), 1, 3, -1, structureBoundingBoxIn);
            return true;
        }
    }
    ...
    abstract static class Village extends StructureComponent
    {
        ...
        protected StructureComponent getNextComponentNN(final Start start, final List<StructureComponent> p_74891_2_, final Random rand, final int p_74891_4_, final int p_74891_5_) {
            if (this.coordBaseMode != null) {
                switch (this.coordBaseMode) {
                    case NORTH: {
                        return func_176066_d(start, p_74891_2_, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                    }
                    case SOUTH: {
                        return func_176066_d(start, p_74891_2_, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                    }
                    case WEST: {
                        return func_176066_d(start, p_74891_2_, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                    case EAST: {
                        return func_176066_d(start, p_74891_2_, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
        ...
        protected StructureComponent getNextComponentPP(final Start start, final List<StructureComponent> p_74894_2_, final Random rand, final int p_74894_4_, final int p_74894_5_) {
            if (this.coordBaseMode != null) {
                switch (this.coordBaseMode) {
                    case NORTH: {
                        return func_176066_d(start, p_74894_2_, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                    }
                    case SOUTH: {
                        return func_176066_d(start, p_74894_2_, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                    }
                    case WEST: {
                        return func_176066_d(start, p_74894_2_, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                    case EAST: {
                        return func_176066_d(start, p_74894_2_, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
        ...
        protected void spawnVillagers(final World worldIn, final StructureBoundingBox p_74893_2_, final int p_74893_3_, final int p_74893_4_, final int p_74893_5_, final int p_74893_6_) {
            if (this.villagersSpawned < p_74893_6_) {
                for (int i = this.villagersSpawned; i < p_74893_6_; ++i) {
                    final int j = this.getXWithOffset(p_74893_3_ + i, p_74893_5_);
                    final int k = this.getYWithOffset(p_74893_4_);
                    final int l = this.getZWithOffset(p_74893_3_ + i, p_74893_5_);
        ...
        protected IBlockState func_175847_a(final IBlockState p_175847_1_) {
            if (this.isDesertVillage) {
                ...
                if (p_175847_1_.getBlock() == Blocks.oak_stairs) {
                    return Blocks.sandstone_stairs.getDefaultState().withProperty((IProperty<Comparable>)BlockStairs.FACING, (Comparable)p_175847_1_.getValue((IProperty<V>)BlockStairs.FACING));
                }
        ...
        protected void setBlockState(final World worldIn, final IBlockState blockstateIn, final int x, final int y, final int z, final StructureBoundingBox boundingboxIn) {
            final IBlockState iblockstate = this.func_175847_a(blockstateIn);
        ...
        protected void fillWithBlocks(final World worldIn, final StructureBoundingBox boundingboxIn, final int xMin, final int yMin, final int zMin, final int xMax, final int yMax, final int zMax, final IBlockState boundaryBlockState, final IBlockState insideBlockState, final boolean existingOnly) {
            final IBlockState iblockstate = this.func_175847_a(boundaryBlockState);
            final IBlockState iblockstate2 = this.func_175847_a(insideBlockState);
            super.fillWithBlocks(worldIn, boundingboxIn, xMin, yMin, zMin, xMax, yMax, zMax, iblockstate, iblockstate2, existingOnly);
        }
    ...
    public static class Well extends Village
    {
        ...
        public Well(final Start start, final int p_i2109_2_, final Random rand, final int p_i2109_4_, final int p_i2109_5_) {
        ...
        @Override
        public void buildComponent(final StructureComponent componentIn, final List<StructureComponent> listIn, final Random rand) {
            func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
            func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
            func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
            func_176069_e((Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
        }
    ...
    public static class WoodHut extends Village
    {
        ...
        public WoodHut(final Start start, final int p_i45565_2_, final Random rand, final StructureBoundingBox p_i45565_4_, final EnumFacing facing) {
        ...
        public static WoodHut func_175853_a(final Start start, final List<StructureComponent> p_175853_1_, final Random rand, final int p_175853_3_, final int p_175853_4_, final int p_175853_5_, final EnumFacing facing, final int p_175853_7_) {
