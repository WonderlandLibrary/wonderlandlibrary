...
public class EntityIdRewriter {
    ...
    public static void toClient(CompoundTag tag, boolean backwards) {
        ...
        if (idTag instanceof StringTag) {
            ...
            String string = newName = backwards ? (String)oldToNewNames.inverse().get(id.getValue()) : (String)oldToNewNames.get(id.getValue());
            if (newName != null) {
                id.setValue(newName);
            }
        }
    ...
    public static void toServerItem(Item item, boolean backwards) {
        ...
        if (idTag instanceof StringTag) {
            String newName;
            StringTag id = (StringTag)idTag;
            String string = newName = backwards ? (String)oldToNewNames.get(id.getValue()) : (String)oldToNewNames.inverse().get(id.getValue());
            if (newName != null) {
                id.setValue(newName);
            }
        }
