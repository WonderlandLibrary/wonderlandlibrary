...
public abstract class BaseConstructor
{
    ...
    public Object getSingleData(final Class<?> type) {
        ...
        final Construct construct = this.yamlConstructors.get(Tag.NULL);
    ...
    protected void postponeMapFilling(final Map<Object, Object> mapping, final Object key, final Object value) {
    ...
    protected void postponeSetFilling(final Set<Object> set, final Object key) {
