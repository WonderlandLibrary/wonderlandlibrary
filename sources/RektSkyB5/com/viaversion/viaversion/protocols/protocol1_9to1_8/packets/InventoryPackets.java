            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler(){
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        for (short i2 = 0; i2 < stacks.length; i2 = (short)((short)(i2 + 1))) {
                            Item stack = stacks[i2];
                            if (showShieldWhenSwordInHand) {
                                inventoryTracker.setItemId(windowId, i2, stack == null ? 0 : stack.identifier());
                            }
                            ItemRewriter.toClient(stack);
                        }
                        if (showShieldWhenSwordInHand) {
                ...
                this.handler(new PacketHandler(){
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        if (inventoryTracker.getInventory() != null && inventoryTracker.getInventory().equals("minecraft:brewing_stand")) {
                            ...
                            for (int i2 = 0; i2 < newStack.length; ++i2) {
                                if (i2 > 4) {
                                    newStack[i2] = oldStack[i2 - 1];
                                    continue;
                                }
                                if (i2 == 4) continue;
                                newStack[i2] = oldStack[i2];
                            }
