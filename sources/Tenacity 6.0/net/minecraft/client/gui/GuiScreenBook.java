...
public class GuiScreenBook extends GuiScreen
{
    ...
    private void sendBookToServer(final boolean publish) throws IOException {
        if (this.bookIsUnsigned && this.bookIsModified && this.bookPages != null) {
            ...
            this.mc2.getNetHandler().addToSendQueue(new C17PacketCustomPayload(s2, packetbuffer));
        }
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.mc2.getTextureManager().bindTexture(GuiScreenBook.bookGuiTextures);
        final int i = (this.width - this.bookImageWidth) / 2;
        final int j = 2;
        ...
        if (this.bookGettingSigned) {
            ...
            final int k = (int)this.fontRendererObj.getStringWidth(s2);
            this.fontRendererObj.drawString(s2, (float)(i + 36 + (116 - k) / 2), (float)(j + 16 + 16), 0);
            final int l = (int)this.fontRendererObj.getStringWidth(s);
            this.fontRendererObj.drawString(s, (float)(i + 36 + (116 - l) / 2), (float)(j + 48), 0);
            final String s3 = I18n.format("book.byAuthor", this.editingPlayer.getName());
            final int i2 = (int)this.fontRendererObj.getStringWidth(s3);
            this.fontRendererObj.drawString(EnumChatFormatting.DARK_GRAY + s3, (float)(i + 36 + (116 - i2) / 2), (float)(j + 48 + 10), 0);
            ...
            final int j2 = (int)this.fontRendererObj.getStringWidth(s5);
            this.fontRendererObj.drawString(s5, (float)(i - j2 + this.bookImageWidth - 44), (float)(j + 16), 0);
            if (this.field_175386_A == null) {
                ...
                for (int k2 = Math.min(128 / this.fontRendererObj.FONT_HEIGHT, this.field_175386_A.size()), l2 = 0; l2 < k2; ++l2) {
                    ...
                    this.fontRendererObj.drawString(ichatcomponent2.getUnformattedText(), (float)(i + 36), (float)(j + 16 + 16 + l2 * this.fontRendererObj.FONT_HEIGHT), 0);
                }
    ...
    protected boolean handleComponentClick(final IChatComponent component) {
        final ClickEvent clickevent = (component == null) ? null : component.getChatStyle().getChatClickEvent();
        if (clickevent == null) {
            return false;
        }
    ...
    public IChatComponent func_175385_b(final int p_175385_1_, final int p_175385_2_) {
        ...
        if (i <= 116 && j < this.mc2.fontRendererObj.FONT_HEIGHT * k + k) {
            final int l = j / this.mc2.fontRendererObj.FONT_HEIGHT;
            if (l >= 0 && l < this.field_175386_A.size()) {
                ...
                for (final IChatComponent ichatcomponent2 : ichatcomponent) {
                    if (ichatcomponent2 instanceof ChatComponentText) {
                        i2 += (int)this.mc2.fontRendererObj.getStringWidth(((ChatComponentText)ichatcomponent2).getChatComponentText_TextValue());
                        if (i2 > i) {
