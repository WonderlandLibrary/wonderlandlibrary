...
implements Serializable {
    ...
    Node<K, V> find(K key, boolean create) {
        ...
        if (nearest != null) {
            ...
            while (true) {
                Node child;
                int n2 = comparison = comparableKey != null ? comparableKey.compareTo(nearest.key) : comparator.compare(key, nearest.key);
                if (comparison == 0) {
                    return nearest;
                }
    ...
    extends AbstractSet<K> {
        ...
        public boolean contains(Object o2) {
            return LinkedHashTreeMap.this.containsKey(o2);
        }
    ...
    extends AbstractSet<Map.Entry<K, V>> {
        ...
        @Override
        public boolean contains(Object o2) {
            return o2 instanceof Map.Entry && LinkedHashTreeMap.this.findByEntry((Map.Entry)o2) != null;
        }
        ...
        public boolean remove(Object o2) {
            ...
            Node node = LinkedHashTreeMap.this.findByEntry((Map.Entry)o2);
            if (node == null) {
                return false;
            }
    ...
    implements Iterator<T> {
        ...
        final Node<K, V> nextNode() {
            Node e2 = this.next;
            if (e2 == LinkedHashTreeMap.this.header) {
