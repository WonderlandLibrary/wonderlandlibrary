...
extends PooledByteBuf<ByteBuffer> {
    ...
    protected short _getShort(int index) {
        short v2 = PlatformDependent.getShort(this.addr(index));
        return NATIVE_ORDER ? v2 : Short.reverseBytes(v2);
    }
    ...
    protected int _getInt(int index) {
        int v2 = PlatformDependent.getInt(this.addr(index));
        return NATIVE_ORDER ? v2 : Integer.reverseBytes(v2);
    }

    @Override
    protected long _getLong(int index) {
        long v2 = PlatformDependent.getLong(this.addr(index));
        return NATIVE_ORDER ? v2 : Long.reverseBytes(v2);
    }
