...
public class RenderManager
{
    ...
    public void cacheActiveRenderInfo(final World worldIn, final IFontRenderer textRendererIn, final Entity livingPlayerIn, final Entity pointedEntityIn, final GameSettings optionsIn, final float partialTicks) {
    ...
    public void renderEntityStaticNoShadow(final Entity entity, final float partialTicks, final boolean p_147936_3_) {
        if (entity.ticksExisted == 0) {
            entity.lastTickPosX = entity.posX;
            entity.lastTickPosY = entity.posY;
            entity.lastTickPosZ = entity.posZ;
        }
        final double d0 = MathUtils.interpolate(entity.lastTickPosX, entity.posX, partialTicks);
        final double d2 = MathUtils.interpolate(entity.lastTickPosY, entity.posY, partialTicks);
        final double d3 = MathUtils.interpolate(entity.lastTickPosZ, entity.posZ, partialTicks);
        final float f = MathUtils.interpolateFloat(entity.prevRotationYaw, entity.rotationYaw, partialTicks);
        final int i = entity.getBrightnessForRender(partialTicks);
        final int j = i % 65536;
        final int k = i / 65536;
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, j / 1.0f, k / 1.0f);
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        this.doRenderEntityNoShadow(entity, d0 - this.renderPosX, d2 - this.renderPosY, d3 - this.renderPosZ, f, partialTicks, p_147936_3_);
    }
    
    public boolean renderEntityStatic(final Entity entity, final float partialTicks, final boolean hideDebugBox) {
        if (entity.ticksExisted == 0) {
            entity.lastTickPosX = entity.posX;
            entity.lastTickPosY = entity.posY;
            entity.lastTickPosZ = entity.posZ;
        ...
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, j / 1.0f, k / 1.0f);
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        return this.doRenderEntity(entity, d0 - this.renderPosX, d2 - this.renderPosY, d3 - this.renderPosZ, f, partialTicks, hideDebugBox);
    }
    ...
    public boolean doRenderEntityNoShadow(final Entity entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks, final boolean hideDebugBox) {
        ...
        try {
            ...
            if (render != null && this.renderEngine != null) {
                ...
                try {
                    ...
                    throw new ReportedException(CrashReport.makeCrashReport(throwable3, "Rendering entity hitbox in world"));
                }
            }
            ...
            final CrashReport crashreport = CrashReport.makeCrashReport(throwable4, "Rendering entity in world");
    ...
    public boolean doRenderEntity(final Entity entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks, final boolean hideDebugBox) {
        ...
        try {
            ...
            if (render != null && this.renderEngine != null) {
                ...
                try {
                    if (!this.renderOutlines && TargetHUDMod.renderLayers) {
