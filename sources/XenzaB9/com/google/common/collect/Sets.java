...
public final class Sets
{
    ...
    public static <E extends Enum<E>> ImmutableSet<E> immutableEnumSet(final Iterable<E> elements) {
        ...
        if (elements instanceof Collection) {
            final Collection<E> collection = (Collection)elements;
    ...
    public static <E> CopyOnWriteArraySet<E> newCopyOnWriteArraySet(final Iterable<? extends E> elements) {
        final Collection<? extends E> elementsCollection = (elements instanceof Collection) ? Collections2.cast(elements) : Lists.newArrayList((Iterable<?>)elements);
    ...
    public static <E extends Enum<E>> EnumSet<E> complementOf(final Collection<E> collection, final Class<E> type) {
        ...
        return (collection instanceof EnumSet) ? EnumSet.complementOf((EnumSet<E>)(EnumSet)collection) : makeComplementByHand((Collection<Enum>)collection, (Class<Enum>)type);
    }
    ...
    public static <E> Set<E> filter(final Set<E> unfiltered, final Predicate<? super E> predicate) {
        ...
        if (unfiltered instanceof FilteredSet) {
            final FilteredSet<E> filtered = (FilteredSet)unfiltered;
