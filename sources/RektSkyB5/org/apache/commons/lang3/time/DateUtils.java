...
public class DateUtils {
    ...
    private static void modify(Calendar val2, int field, ModifyType modType) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            int[] aField;
            for (int element : aField = nArray[i2]) {
