            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (type.is((EntityType)Entity1_10Types.EntityType.BOAT)) {
                        ...
                        shulkerBulletReplacement.setLocation((double)x2 / 32.0, (double)y2 / 32.0, (double)z2 / 32.0);
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (typeId == 69) {
                        ...
                        shulkerReplacement.setLocation((double)x2 / 32.0, (double)y2 / 32.0, (double)z2 / 32.0);
