...
public abstract class InventoryEffectRenderer extends GuiContainer
{
    ...
    protected void updateActivePotionEffects() {
        ...
        if (!this.mc2.thePlayer.getActivePotionEffects().isEmpty()) {
    ...
    private void drawActivePotionEffects() {
        ...
        int j = this.guiTop;
        final int k = 166;
        final Collection<PotionEffect> collection = this.mc2.thePlayer.getActivePotionEffects();
        if (!collection.isEmpty()) {
            ...
            for (final PotionEffect potioneffect : this.mc2.thePlayer.getActivePotionEffects()) {
                final Potion potion = Potion.potionTypes[potioneffect.getPotionID()];
                GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
                this.mc2.getTextureManager().bindTexture(InventoryEffectRenderer.inventoryBackground);
