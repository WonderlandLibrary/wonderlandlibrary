...
Iterable<IntObjectMap.Entry<V>> {
    ...
    public void putAll(IntObjectMap<V> sourceMap) {
        if (sourceMap instanceof IntObjectHashMap) {
            ...
            for (int i2 = 0; i2 < source.values.length; ++i2) {
                V sourceValue = source.values[i2];
                if (sourceValue == null) continue;
                this.put(source.keys[i2], sourceValue);
            }
            return;
        }
    ...
    public boolean containsValue(V value) {
        V v2 = IntObjectHashMap.toInternal(value);
        for (int i2 = 0; i2 < this.values.length; ++i2) {
            if (this.values[i2] == null || !this.values[i2].equals(v2)) continue;
            return true;
        }
        return false;
    }
    ...
    public V[] values(Class<V> clazz) {
        ...
        for (int i2 = 0; i2 < this.values.length; ++i2) {
            if (this.values[i2] == null) continue;
            outValues[targetIx++] = this.values[i2];
        }
        return outValues;
    }
    ...
    private void removeAt(int index) {
        ...
        while (this.values[i2] != null) {
            int bucket = this.hashIndex(this.keys[i2]);
            if (i2 < bucket && (bucket <= nextFree || nextFree <= i2) || bucket <= nextFree && nextFree <= i2) {
                this.keys[nextFree] = this.keys[i2];
                this.values[nextFree] = this.values[i2];
                this.keys[i2] = 0;
                this.values[i2] = null;
                nextFree = i2;
            }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.values.length; ++i2) {
            ...
            sb.append(this.keys[i2]).append('=').append((Object)(value == this ? "(this Map)" : value));
        }
