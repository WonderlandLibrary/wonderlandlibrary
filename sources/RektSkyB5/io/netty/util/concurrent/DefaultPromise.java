...
implements Promise<V> {
    ...
    public Promise<V> addListeners(GenericFutureListener<? extends Future<? super V>> ... listeners) {
        ...
        for (GenericFutureListener<? extends Future<? super V>> l2 : listeners) {
            if (l2 == null) break;
            this.addListener((GenericFutureListener)l2);
        }
        return this;
    }
    ...
    public Promise<V> removeListeners(GenericFutureListener<? extends Future<? super V>> ... listeners) {
        ...
        for (GenericFutureListener<? extends Future<? super V>> l2 : listeners) {
            if (l2 == null) break;
            this.removeListener((GenericFutureListener)l2);
        }
        return this;
    }
    ...
    private void notifyListeners() {
        ...
        if (executor.inEventLoop() && (stackDepth = (threadLocals = InternalThreadLocalMap.get()).futureListenerStackDepth()) < 8) {
            ...
            try {
                if (listeners instanceof DefaultFutureListeners) {
                    ...
                    GenericFutureListener l2 = (GenericFutureListener)listeners;
                    DefaultPromise.notifyListener0(this, l2);
                }
            }
            finally {
                this.listeners = null;
        ...
        if (listeners instanceof DefaultFutureListeners) {
            ...
            final GenericFutureListener l3 = (GenericFutureListener)listeners;
            DefaultPromise.execute(executor, new Runnable(){

                @Override
                public void run() {
                    DefaultPromise.notifyListener0(DefaultPromise.this, l3);
                    DefaultPromise.this.listeners = null;
                }
            });
        }
    ...
    private static void notifyListeners0(Future<?> future, DefaultFutureListeners listeners) {
        ...
        for (int i2 = 0; i2 < size; ++i2) {
            DefaultPromise.notifyListener0(future, a2[i2]);
        }
    }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    private void notifyLateListener(GenericFutureListener<?> l2) {
        EventExecutor executor = this.executor();
        if (executor.inEventLoop()) {
            if (this.listeners == null && this.lateListeners == null) {
                ...
                lateListeners.add(l2);
                DefaultPromise.execute(executor, lateListeners);
                return;
            }
        }
        DefaultPromise.execute(executor, new LateListenerNotifier(l2));
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    protected static void notifyListener(EventExecutor eventExecutor, final Future<?> future, final GenericFutureListener<?> l2) {
        InternalThreadLocalMap threadLocals;
        int stackDepth;
        if (eventExecutor.inEventLoop() && (stackDepth = (threadLocals = InternalThreadLocalMap.get()).futureListenerStackDepth()) < 8) {
            threadLocals.setFutureListenerStackDepth(stackDepth + 1);
            try {
                DefaultPromise.notifyListener0(future, l2);
            }
            finally {
                threadLocals.setFutureListenerStackDepth(stackDepth);
            }
    ...
    static void notifyListener0(Future future, GenericFutureListener l2) {
        block2: {
            try {
    ...
    implements Runnable {
        ...
        LateListenerNotifier(GenericFutureListener<?> l2) {
            this.l = l2;
        }
    ...
    implements Runnable {
        ...
        public void run() {
            if (DefaultPromise.this.listeners == null) {
                GenericFutureListener l2;
                while ((l2 = (GenericFutureListener)this.poll()) != null) {
