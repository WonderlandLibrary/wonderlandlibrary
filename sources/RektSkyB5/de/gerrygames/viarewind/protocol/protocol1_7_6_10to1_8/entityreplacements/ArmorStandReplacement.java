...
implements EntityReplacement {
    ...
    public void updateMetadata(List<Metadata> metadataList) {
        for (Metadata metadata : metadataList) {
            this.datawatcher.removeIf(m2 -> m2.id() == metadata.id());
    ...
    public AABB getBoundingBox() {
        double w2 = this.small ? 0.25 : 0.5;
        double h2 = this.small ? 0.9875 : 1.975;
        Vector3d min = new Vector3d(this.locX - w2 / 2.0, this.locY, this.locZ - w2 / 2.0);
        Vector3d max = new Vector3d(this.locX + w2 / 2.0, this.locY + h2, this.locZ + w2 / 2.0);
