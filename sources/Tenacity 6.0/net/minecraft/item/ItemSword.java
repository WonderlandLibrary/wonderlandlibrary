...
public class ItemSword extends Item
{
    ...
    public boolean onBlockDestroyed(final ItemStack stack, final World worldIn, final Block blockIn, final BlockPos pos, final EntityLivingBase playerIn) {
        if (blockIn.getBlockHardness() != 0.0) {
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(ItemSword.itemModifierUUID, "Weapon modifier", this.attackDamage, 0));
        return multimap;
    }
}
