...
extends Property {
    ...
    public void setActualTypeArguments(Class<?> ... args2) {
        this.parameters = args2 != null && args2.length > 0 ? args2 : null;
    }
    ...
    public <A extends Annotation> A getAnnotation(Class<A> annotationType) {
        A annotation2 = this.read != null ? this.read.getAnnotation(annotationType) : (this.field != null ? this.field.getAnnotation(annotationType) : this.delegate.getAnnotation(annotationType));
        return annotation2;
    }
