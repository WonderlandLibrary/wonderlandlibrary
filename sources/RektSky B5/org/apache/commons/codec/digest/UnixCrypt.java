...
public class UnixCrypt {
    ...
    private static int dEncrypt(int el, int r2, int s2, int e0, int e1, int[] sArr) {
        int v2 = r2 ^ r2 >>> 16;
        int u2 = v2 & e0;
        u2 = u2 ^ u2 << 16 ^ r2 ^ sArr[s2];
        int t2 = (v2 &= e1) ^ v2 << 16 ^ r2 ^ sArr[s2 + 1];
        t2 = t2 >>> 4 | t2 << 28;
        return el ^= SPTRANS[1][t2 & 0x3F] | SPTRANS[3][t2 >>> 8 & 0x3F] | SPTRANS[5][t2 >>> 16 & 0x3F] | SPTRANS[7][t2 >>> 24 & 0x3F] | SPTRANS[0][u2 & 0x3F] | SPTRANS[2][u2 >>> 8 & 0x3F] | SPTRANS[4][u2 >>> 16 & 0x3F] | SPTRANS[6][u2 >>> 24 & 0x3F];
    }
