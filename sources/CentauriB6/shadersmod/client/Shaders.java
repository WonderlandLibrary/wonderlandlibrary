...
public class Shaders {
   ...
   private static final int[] formatIds = new int[]{'舩', '舫', '聑', '聘', '辔', '辕', '辖', '辗', '航', '般', '联', '聛', '辘', '辙', '辚', '辛', '舮', '舰', '蠕', '蠔', '舵', '舻', '趃', '趂', '舶', '舼', '赱', '走'};
   ...
   public static void renderCompositeFinal() {
      if(!isShadowPass) {
         ...
         for(int j1 = 0; j1 < usedShadowColorBuffers; ++j1) {
            GlStateManager.setActiveTexture('蓍' + j1);
            ...
            if(programsID[21 + k1] != 0) {
               ...
               for(int k = 0; k < usedColorBuffers; ++k) {
                  if(programsToggleColorTextures[21 + k1][k]) {
                     ...
                     GlStateManager.setActiveTexture('蓀' + colorTextureTextureImageUnit[k]);
   ...
   public static ShaderOption[] getChangedOptions(ShaderOption[] ops) {
      ...
      ShaderOption[] ashaderoption = (ShaderOption[])((ShaderOption[])((ShaderOption[])list.toArray(new ShaderOption[list.size()])));
      return ashaderoption;
   }
   ...
   public static ShaderOption[] getShaderPackOptions(String screenName) {
      ShaderOption[] ashaderoption = (ShaderOption[])((ShaderOption[])shaderPackOptions.clone());
      if(shaderPackGuiScreens == null) {
         if(shaderPackProfiles != null) {
            ...
            ashaderoption = (ShaderOption[])((ShaderOption[])((ShaderOption[])Config.addObjectToArray(ashaderoption, shaderoptionprofile, 0)));
         }
         ...
         ShaderOption[] ashaderoption1 = (ShaderOption[])((ShaderOption[])shaderPackGuiScreens.get(s));
         if(ashaderoption1 == null) {
            ...
            ShaderOption[] ashaderoption3 = (ShaderOption[])((ShaderOption[])((ShaderOption[])list.toArray(new ShaderOption[list.size()])));
   ...
   private static ShaderOption[] getShaderOptionsRest(Map mapScreens, ShaderOption[] ops) {
      ...
      for(String s : mapScreens.keySet()) {
         ShaderOption[] ashaderoption = (ShaderOption[])((ShaderOption[])mapScreens.get(s));
      ...
      ShaderOption[] ashaderoption1 = (ShaderOption[])((ShaderOption[])((ShaderOption[])list.toArray(new ShaderOption[list.size()])));
         ...
         try {
            for(String s3 : list) {
               ...
               if(inputstream != null) {
                  ...
                  for(Object os4 : properties.keySet()) {
                     String s4 = (String)os4;
   ...
   public static void checkShadersModInstalled() {
      try {
         Class var1 = Class.forName("shadersmod.transform.SMCClassTransformer");
   ...
   private static void setupFrameBuffer() {
      ...
      for(int k = 0; k < usedColorBuffers; ++k) {
         ...
         GL11.glTexParameteri(3553, 10241, 9729);
         GL11.glTexParameteri(3553, 10240, 9729);
         GL11.glTexImage2D(3553, 0, gbuffersFormat[k], renderWidth, renderHeight, 0, '胡', '荧', (ByteBuffer)null);
      ...
      for(int l = 0; l < usedColorBuffers; ++l) {
         ...
         GL11.glTexParameteri(3553, 10241, 9729);
         GL11.glTexParameteri(3553, 10240, 9729);
         GL11.glTexImage2D(3553, 0, gbuffersFormat[l], renderWidth, renderHeight, 0, '胡', '荧', (ByteBuffer)null);
         checkGLError("FT ca");
      }
   ...
   private static boolean printLogInfo(int obj, String name) {
      IntBuffer intbuffer = BufferUtils.createIntBuffer(1);
      ARBShaderObjects.glGetObjectParameterARB(obj, '讄', intbuffer);
      int i = intbuffer.get();
      if(i > 1) {
   ...
   public static void useProgram(int program) {
      ...
      if(activeProgram != program) {
         ...
         if(programsID[program] == 0) {
            ...
            setProgramUniform1i("hideGUI", mc.gameSettings.thirdPersonView?1:0);
   ...
   public static void beginRender(Minecraft minecraft, float partialTicks, long finishTimeNano) {
      ...
      isEyeInWater = mc.gameSettings.showDebugInfo == 0 && !isSleeping && mc.thePlayer.isInsideOfMaterial(Material.water)?1:0;
      ...
      for(int j = 0; j < 4 && 4 + j < usedColorBuffers; ++j) {
         GlStateManager.setActiveTexture('蓇' + j);
      ...
      for(int l = 0; l < usedColorBuffers; ++l) {
         ...
         EXTFramebufferObject.glFramebufferTexture2DEXT('赀', '賠' + l, 3553, dfbColorTexturesA[l], 0);
      }
