...
package dev.tenacity.viamcp.handler;
...
public class CommonTransformer
{
    ...
    public static void decompress(final ChannelHandlerContext ctx, final ByteBuf buf) throws InvocationTargetException {
        ...
        final ByteBuf decompressed = (handler instanceof MessageToMessageDecoder) ? PipelineUtil.callDecode((MessageToMessageDecoder)handler, ctx, (Object)buf).get(0) : PipelineUtil.callDecode((ByteToMessageDecoder)handler, ctx, (Object)buf).get(0);
        try {
