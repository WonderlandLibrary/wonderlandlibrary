...
implements TypeTag {
    ...
    private int doOpcode54_95(int pos, byte[] code, int op) throws BadBytecode {
        switch (op) {
            ...
            case 66: {
                int var3 = op - 63;
                this.localsTypes[var3] = LONG;
                this.localsTypes[var3 + 1] = TOP;
                this.stackTop -= 2;
                break;
            }
            case 67: 
            ...
            case 74: {
                int var5 = op - 71;
                this.localsTypes[var5] = DOUBLE;
                this.localsTypes[var5 + 1] = TOP;
                this.stackTop -= 2;
                break;
            }
            case 75: 
