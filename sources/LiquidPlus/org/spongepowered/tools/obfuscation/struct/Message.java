...
public class Message {
    ...
    public Message(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationHandle annotation2) {
        this(kind, msg, element, annotation2.asMirror(), null);
    }

    public Message(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationMirror annotation2) {
        this(kind, msg, element, annotation2, null);
    }

    public Message(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationHandle annotation2, AnnotationValue value) {
        this(kind, msg, element, annotation2.asMirror(), value);
    }

    public Message(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationMirror annotation2, AnnotationValue value) {
        this.kind = kind;
        this.msg = msg;
