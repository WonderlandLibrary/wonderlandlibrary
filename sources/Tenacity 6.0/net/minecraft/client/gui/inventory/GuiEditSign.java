...
public class GuiEditSign extends GuiScreen
{
    ...
    public void onGuiClosed() {
        ...
        final NetHandlerPlayClient nethandlerplayclient = this.mc2.getNetHandler();
    ...
    protected void keyTyped(final char typedChar, final int keyCode) throws IOException {
        ...
        if (ChatAllowedCharacters.isAllowedCharacter(typedChar) && this.fontRendererObj.getStringWidth(s + typedChar) <= 90.0f) {
            s += typedChar;
        }
