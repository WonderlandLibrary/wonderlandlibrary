...
public final class AnnotationHandle {
    ...
    private AnnotationHandle(AnnotationMirror annotation2) {
    ...
    public static AnnotationHandle of(AnnotationMirror annotation2) {
        return new AnnotationHandle(annotation2);
    }
