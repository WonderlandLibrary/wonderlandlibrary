...
public class GuiControls extends GuiScreen
{
    ...
    @Override
    public void initGui() {
        this.keyBindingList = new GuiKeyBindingList(this, this.mc2);
        ...
        int i = 0;
        for (final GameSettings.Options gamesettings$options : GuiControls.optionsArr) {
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.id == 200) {
            ...
            for (final KeyBinding keybinding : this.mc2.gameSettings.keyBindings) {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        boolean flag = true;
        for (final KeyBinding keybinding : this.options.keyBindings) {
