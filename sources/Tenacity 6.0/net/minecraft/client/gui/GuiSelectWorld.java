...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        (this.availableWorlds = new List(this.mc2)).registerScrollButtons(4, 5);
    ...
    private void loadLevelList() throws AnvilConverterException {
        final ISaveFormat isaveformat = this.mc2.getSaveLoader();
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == 2) {
                ...
                final ISaveHandler isavehandler = this.mc2.getSaveLoader().getSaveLoader(this.func_146621_a(this.selectedIndex), false);
    ...
    public void func_146615_e(final int p_146615_1_) {
        ...
        if (!this.field_146634_i) {
            ...
            if (this.mc2.getSaveLoader().canLoadWorld(s)) {
                this.mc2.launchIntegratedServer(s, s2, null);
            }
        }
    }
