...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    public void reloadResources(final List<IResourcePack> resourcesPacksList) {
        this.clearResources();
        SimpleReloadableResourceManager.logger.info("Reloading ResourceManager: " + SimpleReloadableResourceManager.joinerResourcePacks.join(Iterables.transform((Iterable)resourcesPacksList, (Function)new Function<IResourcePack, String>() {
