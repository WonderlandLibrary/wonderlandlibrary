...
public class ShaderPackParser {
   ...
   public static ShaderOption[] parseShaderPackOptions(IShaderPack shaderPack, String[] programNames, List listDimensions) {
      if(shaderPack == null) {
         ...
         ShaderOption[] ashaderoption = (ShaderOption[])((ShaderOption[])((ShaderOption[])collection.toArray(new ShaderOption[collection.size()])));
         Comparator<ShaderOption> comparator = new Comparator() {
   ...
   public static ShaderProfile[] parseProfiles(Properties props, ShaderOption[] shaderOptions) {
      ...
      for(Object os1 : props.keySet()) {
         String s1 = (String)os1;
         if(s1.startsWith(s)) {
      ...
      if(list.size() <= 0) {
         ...
         ShaderProfile[] ashaderprofile = (ShaderProfile[])((ShaderProfile[])((ShaderProfile[])list.toArray(new ShaderProfile[list.size()])));
