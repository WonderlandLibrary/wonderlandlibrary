...
public class TextureAtlasSprite
{
    ...
    public void loadSprite(final BufferedImage[] images, final AnimationMetadataSection meta) throws IOException {
        ...
        if (meta == null) {
            ...
            if (meta.getFrameCount() > 0) {
                for (final Integer integer : meta.getFrameIndexSet()) {
                    final int i2 = integer;
                    if (i2 >= j2) {
                        throw new RuntimeException("invalid frameindex " + i2);
                    }
                    this.allocateFrameTextureData(i2);
                    this.framesTextureData.set(i2, getFrameTextureData(aint, i, i, i2));
                }
                ...
                for (int j3 = 0; j3 < j2; ++j3) {
                    this.framesTextureData.add(getFrameTextureData(aint, i, i, j3));
        ...
        if (!this.isShadersSprite) {
            ...
            for (final int[][] framesTextureDatum : this.framesTextureData) {
                if (framesTextureDatum != null && !this.iconName.startsWith("minecraft:blocks/leaves_")) {
                    for (int i3 = 0; i3 < framesTextureDatum.length; ++i3) {
                        final int[] aint2 = framesTextureDatum[i3];
    ...
    private void fixTransparentColor(final int[] p_fixTransparentColor_1_) {
        if (p_fixTransparentColor_1_ != null) {
            ...
            long k = 0L;
            long l = 0L;
            for (final int j2 : p_fixTransparentColor_1_) {
                final int k2 = j2 >> 24 & 0xFF;
                if (k2 >= 16) {
                    final int l2 = j2 >> 16 & 0xFF;
                    final int i2 = j2 >> 8 & 0xFF;
            ...
            if (l > 0L) {
                ...
                final int i3 = (int)(j / l);
                final int j4 = (int)(k / l);
                final int k3 = l3 << 16 | i3 << 8 | j4;
                for (int l4 = 0; l4 < p_fixTransparentColor_1_.length; ++l4) {
                    final int i4 = p_fixTransparentColor_1_[l4];
                    final int k4 = i4 >> 24 & 0xFF;
                    if (k4 <= 16) {
