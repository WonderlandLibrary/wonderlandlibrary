...
public class ItemPotion extends Item
{
    ...
    public List<PotionEffect> getEffects(final ItemStack stack) {
        ...
        if (list2 == null) {
            list2 = PotionHelper.getPotionEffects(stack.getMetadata(), false);
    ...
    public String getItemStackDisplayName(final ItemStack stack) {
        ...
        return StatCollector.translateToLocal(s3).trim() + " " + super.getItemStackDisplayName(stack);
    }
                ...
                for (final PotionEffect potioneffect : list) {
                    ...
                    if (map != null && map.size() > 0) {
                        for (final Map.Entry<IAttribute, AttributeModifier> entry : map.entrySet()) {
                            ...
                            multimap.put((Object)entry.getKey().getAttributeUnlocalizedName(), (Object)attributemodifier2);
                        }
                    }
            ...
            for (int i = 0; i <= 15; ++i) {
                for (int j = 0; j <= 1; ++j) {
                    ...
                    for (int l = 0; l <= 2; ++l) {
                        ...
                        final List<PotionEffect> list = PotionHelper.getPotionEffects(i2, false);
                        if (list != null && !list.isEmpty()) {
