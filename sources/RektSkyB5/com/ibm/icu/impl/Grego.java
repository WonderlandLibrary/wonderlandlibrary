...
public class Grego {
    ...
    public static long fieldsToDay(int year, int month, int dom) {
        int y2 = year - 1;
        long julian = (long)(365 * y2) + Grego.floorDivide(y2, 4L) + 1721423L + Grego.floorDivide(y2, 400L) - Grego.floorDivide(y2, 100L) + 2L + (long)DAYS_BEFORE[month + (Grego.isLeapYear(year) ? 12 : 0)] + (long)dom;
